...
class Staff_model extends CRM_Model
{
    ...
    public function add($data)
    {
        ...
        if ($staffid) {
            ...
            if ($roleid == 3) {
                $teamname = $this->get_manager_team($this->session->userdata('staff_user_id'));
                $this->assign_employee_team($staffid, $teamname);
            }
     ...
     * @return mixed
     */
    public function get_manager_team($staffid)
    {
     ...
     * @param $teamname
     */
    public function assign_employee_team($staffid, $teamname)
    {
        $query = "insert into tblcustomfieldsvalues 
                (relid,
                fieldid,
                fieldto,
                value) values ($staffid,9,'staff','$teamname')";
        $this->db->query($query);
    }
