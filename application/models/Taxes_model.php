...
class Taxes_model extends CRM_Model
{
    ...
    {
        if (is_reference_in_table('tax', 'tblitems', $id) || is_reference_in_table('tax2', 'tblitems', $id) || is_reference_in_table('tax', 'tblexpenses', $id) || is_reference_in_table('tax2', 'tblexpenses', $id)) {
            return array(
                'referenced' => true
            );
        }
