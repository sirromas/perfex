...
{
    private $pdf_fields = array('estimate', 'invoice', 'proposal');
    private $client_portal_fields = array('customers', 'estimate', 'invoice', 'proposal', 'contracts', 'tasks', 'projects', 'contacts', 'tickets', 'company');
