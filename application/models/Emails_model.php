...
class Emails_model extends CRM_Model
{
     ...
     * @param
     *            string
     * @return array Get email template by type
     */
     ...
     * @param
     *            integer
     * @return object Get email template by id
     */
     ...
     * @param
     *            integer ID
     * @return boolean Update email template
     */
     ...
     *            used only when sending email templates linked to ticket / used for piping
     * @param mixed $cc            
     * @return boolean
     */
     ...
     * @param
     *            string (mime type)
     * @return none Add attachment to property to check before an email is send
     */
    ...
    /**
     *
     * @return none Clear all attachment properties
     */
