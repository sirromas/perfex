...
class Departments_model extends CRM_Model
{
     ...
     * @param
     *            boolean (optional)
     * @return mixed Get department object based on passed id if not passed id return array of all departments
     ...
     * @param array $_POST
     *            data
     * @return integer Add new department
     */
     ...
     * @param
     *            integer ID
     * @return boolean Update department to database
     */
     ...
     * @param
     *            integer ID
     * @return mixed Delete department from database, if used return array with key referenced
     */
     ...
     * @param
     *            boolean (optional)
     * @return mixed Get departments where staff belongs
