...
class Contracts_model extends CRM_Model
{
     ...
     *            if for editor is false will replace the field if not will not replace
     * @return mixed
     */
     ...
     * @param
     *            integer ID
     * @return object Retrieve contract attachments from database
     */
     ...
     * @param
     *            integer ID
     * @return boolean Delete contract, also attachment will be removed if any found
     */
     ...
     * @param
     *            integer ID (optional)
     * @return mixed Get contract type object based on passed id if not passed id return array of all types
     */
     ...
     * @param
     *            integer ID
     * @return mixed Delete contract type from database, if used return array with key referenced
     */
