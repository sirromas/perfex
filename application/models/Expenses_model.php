...
class Expenses_model extends CRM_Model
{
    ...
    {
        $this->db->select('*,tblexpenses.id as id,tblexpensescategories.name as category_name,tblinvoicepaymentsmodes.name as payment_mode_name,tbltaxes.name as tax_name, tbltaxes.taxrate as taxrate,tbltaxes_2.name as tax_name2, tbltaxes_2.taxrate as taxrate2, tblexpenses.id as expenseid');
     ...
     * @param
     *            integer ID
     * @return mixed Delete expense from database, if used return
     */
    ...
    public function convert_to_invoice($id, $draft_invoice = false, $params = array())
    {
        ...
        if ($invoiceid) {
            ...
            do_action('expense_converted_to_invoice', array(
     ...
     * @param
     *            integer ID
     * @return mixed Delete expense category from database, if used return array with key referenced
     */
