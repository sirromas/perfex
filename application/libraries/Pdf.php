...
class Pdf extends TCPDF
{
    ...
    {
        if (($this->pdf_type == 'invoice' && get_option('show_pdf_signature_invoice') == 1) || ($this->pdf_type == 'estimate' && get_option('show_pdf_signature_estimate') == 1)) {
