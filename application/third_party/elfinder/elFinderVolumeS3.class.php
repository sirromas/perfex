...
class elFinderVolumeS3 extends elFinderVolumeDriver
{
    ...
    protected function _stat($path)
    {
        ...
        try {
            $files = $this->s3->ListBucket(array(
                'Bucket' => $this->options['bucket'],
                'Prefix' => $np,
                'Delimiter' => '/'
            ))->ListBucketResponse->Contents;
        } catch (Exception $e) {}
    ...
    protected function _fopen($path, $mode = "rb")
    {
        ...
        $fp = $this->tmbPath ? @fopen($tn, 'w+') : @tmpfile();
    ...
    protected function _mkdir($path, $name)
    {
        ...
        try {
            $obj = $this->s3->PutObjectInline(array(
                'Bucket' => $this->options['bucket'],
                'Key' => $newkey,
                'ContentLength' => 0,
                'Data' => ''
    ...
    protected function _unlink($path)
    {
        ...
        try {
            $obj = $this->s3->DeleteObject(array(
                'Bucket' => $this->options['bucket'],
                'Key' => $newkey
            ));
        } catch (Exception $e) {}
