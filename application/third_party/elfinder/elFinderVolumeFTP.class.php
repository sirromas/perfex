...
class elFinderVolumeFTP extends elFinderVolumeDriver
{
     ...
     * Return array(read => true/false, write => true/false)
     *
     * @param string $perm
     *            permissions string
     * @param string $user            
     ...
     *
     * @param $remote_directory string
     *            remote FTP path to a source directory to download from.
     * @param array $files
     *            list of files to download from remote directory.
     * @param $dest_local_directory string
     *            destination folder to store downloaded files.
