...
class ListTransferReversalsRequestTest extends TestCase
{
    ...
    public function testSendSuccess()
    {
        $this->setMockHttpResponse(array(
            Response::fromMessage(file_get_contents($this->mockDir . '/ListTransferReversalsSuccess.txt'))
        ));
    ...
    public function testSendFailure()
    {
        ...
        $this->setMockHttpResponse(array(
            Response::fromMessage(file_get_contents($this->mockDir . '/ListTransferReversalsFailure.txt'))
        ));
        $response = $this->request->send();
