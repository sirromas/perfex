...
class CreateTransferRequestTest extends TestCase
{
    ...
    public function testSendSuccess()
    {
        $this->setMockHttpResponse(array(
            Response::fromMessage(file_get_contents($this->mockDir . '/CreateTransferRequestSuccess.txt'))
        ));
    ...
    {
        $this->setMockHttpResponse(array(
            Response::fromMessage(file_get_contents($this->mockDir . '/CreateTransferRequestFailure.txt'))
        ));
        $response = $this->request->send();
