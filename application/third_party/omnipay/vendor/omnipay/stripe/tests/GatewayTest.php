...
class GatewayTest extends GatewayTestCase
{
    ...
    {
        $request = $this->gateway->createPlan(array(
            'id' => 'basic'
        ));
    ...
    {
        $request = $this->gateway->fetchPlan(array(
            'id' => 'basic'
        ));
    ...
    {
        $request = $this->gateway->deletePlan(array(
            'id' => 'basic'
        ));
    ...
    {
        $request = $this->gateway->updateSubscription(array(
            'subscriptionReference' => 'sub_1mokfidgjdidf'
        ));
    ...
    {
        $request = $this->gateway->fetchEvent(array(
            'eventReference' => 'evt_17X23UCryC4r2g4vdolh6muI'
        ));
    ...
    {
        $request = $this->gateway->fetchInvoiceLines(array(
            'invoiceReference' => 'in_17ZPbRCryC4r2g4vIdAFxptK'
        ));
    ...
    {
        $request = $this->gateway->fetchInvoice(array(
            'invoiceReference' => 'in_17ZPbRCryC4r2g4vIdAFxptK'
        ));
    ...
    {
        $request = $this->gateway->createInvoiceItem(array(
            'invoiceItemReference' => 'ii_17ZPbRCryC4r2g4vIdAFxptK'
        ));
    ...
    {
        $request = $this->gateway->fetchInvoiceItem(array(
            'invoiceItemReference' => 'ii_17ZPbRCryC4r2g4vIdAFxptK'
        ));
    ...
    {
        $request = $this->gateway->deleteInvoiceItem(array(
            'invoiceItemReference' => 'ii_17ZPbRCryC4r2g4vIdAFxptK'
        ));
