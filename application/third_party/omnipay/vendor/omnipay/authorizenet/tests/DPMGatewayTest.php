...
class DPMGatewayTest extends GatewayTestCase
{
    ...
    {
        $this->assertEquals('https://secure2.authorize.net/gateway/transact.dll', $this->gateway->getLiveEndpoint());
    }

    public function testDeveloperEndpoint()
    {
        $this->assertEquals('https://test.authorize.net/gateway/transact.dll', $this->gateway->getDeveloperEndpoint());
    }
