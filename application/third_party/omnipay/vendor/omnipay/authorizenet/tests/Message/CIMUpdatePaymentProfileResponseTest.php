...
class CIMUpdatePaymentProfileResponseTest extends TestCase
{
    ...
    public function testCreateCardSuccess()
    {
        ...
        $mockRequest->shouldReceive('getCustomerProfileId')
            ->times(1)
            ->andReturn('28775801');
        $mockRequest->shouldReceive('getCustomerPaymentProfileId')
            ->times(1)
            ->andReturn('26455709');
        ...
        $this->assertEquals('{"customerProfileId":"28775801","customerPaymentProfileId":"26455709"}', $response->getCardReference());
    }
}
