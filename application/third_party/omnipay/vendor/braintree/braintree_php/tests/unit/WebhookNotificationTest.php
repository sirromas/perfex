...
class WebhookNotificationTest extends Setup
{
    ...
    public function testParsingUnknownPublicKeyRaisesError()
    {
        ...
        $webhookNotification = Braintree\WebhookNotification::parse("bad" . $sampleNotification['bt_signature'], $sampleNotification['bt_payload']);
    }
    ...
    public function testParsingInvalidSignatureRaisesError()
    {
        ...
        $webhookNotification = Braintree\WebhookNotification::parse("bad_signature", $sampleNotification['bt_payload']);
    }
    ...
    public function testParsingInvalidCharactersRaisesError()
    {
        ...
        $webhookNotification = Braintree\WebhookNotification::parse($sampleNotification['bt_signature'], "~*~*invalid*~*~");
    }
    ...
    public function testParsingAllowsAllValidCharacters()
    {
        ...
        $webhookNotification = Braintree\WebhookNotification::parse($sampleNotification['bt_signature'], "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789+=/\n");
    }
    ...
    public function testParsingRetriesPayloadWithANewline()
    {
        ...
        $webhookNotification = Braintree\WebhookNotification::parse($sampleNotification['bt_signature'], rtrim($sampleNotification['bt_payload']));
    }

    public function testAllowsParsingUsingGateway()
    {
        Braintree\Configuration::reset();
        $sampleNotification = Braintree\WebhookTesting::sampleNotification(Braintree\WebhookNotification::CHECK, "my_id");
        ...
        $webhookNotification = $gateway->webhookNotification()->parse($sampleNotification['bt_signature'], $sampleNotification['bt_payload']);
    ...
    {
        $sampleNotification = Braintree\WebhookTesting::sampleNotification(Braintree\WebhookNotification::SUBSCRIPTION_CHARGED_SUCCESSFULLY, "my_id");
    ...
    {
        $sampleNotification = Braintree\WebhookTesting::sampleNotification(Braintree\WebhookNotification::SUB_MERCHANT_ACCOUNT_APPROVED, "my_id");
    ...
    {
        $sampleNotification = Braintree\WebhookTesting::sampleNotification(Braintree\WebhookNotification::SUB_MERCHANT_ACCOUNT_DECLINED, "my_id");
    ...
    {
        $sampleNotification = Braintree\WebhookTesting::sampleNotification(Braintree\WebhookNotification::TRANSACTION_DISBURSED, "my_id");
    ...
    {
        $sampleNotification = Braintree\WebhookTesting::sampleNotification(Braintree\WebhookNotification::TRANSACTION_SETTLED, "my_id");
    ...
    {
        $sampleNotification = Braintree\WebhookTesting::sampleNotification(Braintree\WebhookNotification::TRANSACTION_SETTLEMENT_DECLINED, "my_id");
    ...
    {
        $sampleNotification = Braintree\WebhookTesting::sampleNotification(Braintree\WebhookNotification::DISPUTE_OPENED, "my_id");
    ...
    {
        $sampleNotification = Braintree\WebhookTesting::sampleNotification(Braintree\WebhookNotification::DISPUTE_LOST, "my_id");
    ...
    {
        $sampleNotification = Braintree\WebhookTesting::sampleNotification(Braintree\WebhookNotification::DISPUTE_WON, "my_id");
    ...
    {
        $sampleNotification = Braintree\WebhookTesting::sampleNotification(Braintree\WebhookNotification::DISBURSEMENT_EXCEPTION, "my_id");
    ...
    {
        $sampleNotification = Braintree\WebhookTesting::sampleNotification(Braintree\WebhookNotification::DISBURSEMENT, "my_id");
    ...
    {
        $sampleNotification = Braintree\WebhookTesting::sampleNotification(Braintree\WebhookNotification::PARTNER_MERCHANT_CONNECTED, "my_id");
    ...
    {
        $sampleNotification = Braintree\WebhookTesting::sampleNotification(Braintree\WebhookNotification::PARTNER_MERCHANT_DISCONNECTED, "my_id");
    ...
    public function testBuildsASampleNotificationForConnectedMerchantStatusTransitionedWebhook()
    {
        ...
        $sampleNotification = Braintree\WebhookTesting::sampleNotification(Braintree\WebhookNotification::CONNECTED_MERCHANT_STATUS_TRANSITIONED, "my_id");
    ...
    {
        $sampleNotification = Braintree\WebhookTesting::sampleNotification(Braintree\WebhookNotification::CONNECTED_MERCHANT_PAYPAL_STATUS_CHANGED, "my_id");
