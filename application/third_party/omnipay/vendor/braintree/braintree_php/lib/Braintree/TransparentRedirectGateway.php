...
class TransparentRedirectGateway
{
    ...
    {
        Util::verifyKeys(self::$_createCreditCardSignature, $params);
    ...
    {
        Util::verifyKeys(self::$_createCustomerSignature, $params);
    ...
    {
        Util::verifyKeys(self::$_transactionSignature, $params);
    ...
    {
        Util::verifyKeys(self::$_updateCreditCardSignature, $params);
    ...
    private function _data($params)
    {
        ...
        $signatureService = new SignatureService($this->_config->privateKey(), "Braintree\Digest::hexDigestSha1");
