...
class CreditCardGateway
{
    ...
    public function createFromTransparentRedirect($queryString)
    {
        ...
        return $this->_doCreate('/payment_methods/all/confirm_transparent_redirect_request', [
            'id' => $params['id']
        ]);
    }
    ...
    public function createCreditCardUrl()
    {
        ...
        return $this->_config->baseUrl() . $this->_config->merchantPath() . '/payment_methods/all/create_via_transparent_redirect_request';
    }
    ...
    public function find($token)
    {
        ...
        try {
            ...
            throw new Exception\NotFound('credit card with token ' . $token . ' not found');
        }
    }
    ...
    {
        trigger_error("DEPRECATED: Please use TransparentRedirectRequest::url", E_USER_NOTICE);
        return $this->_config->baseUrl() . $this->_config->merchantPath() . '/payment_methods/all/update_via_transparent_redirect_request';
    }
    ...
    public function updateFromTransparentRedirect($queryString)
    {
        trigger_error("DEPRECATED: Please use TransparentRedirectRequest::confirm", E_USER_NOTICE);
        $params = TransparentRedirect::parseAndValidateQueryString($queryString);
        return $this->_doUpdate('post', '/payment_methods/all/confirm_transparent_redirect_request', [
            'id' => $params['id']
        ]);
    }
     ...
     *            $identifierType type of identifier supplied, default "token"
