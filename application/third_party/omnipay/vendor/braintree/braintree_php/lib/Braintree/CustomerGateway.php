...
class CustomerGateway
{
    ...
    /**
     * Creates a customer using the given +attributes+.
     * If <tt>:id</tt> is not passed,
    ...
    public function createFromTransparentRedirect($queryString)
    {
        ...
        return $this->_doCreate('/customers/all/confirm_transparent_redirect_request', [
            'id' => $params['id']
        ]);
    }
    ...
    public function createCustomerUrl()
    {
        ...
        return $this->_config->baseUrl() . $this->_config->merchantPath() . '/customers/all/create_via_transparent_redirect_request';
    }
     ...
     * @return Customer|boolean customer object or false if the request fails.
    ...
    public function credit($customerId, $transactionAttribs)
    {
        ...
        return Transaction::credit(array_merge($transactionAttribs, [
    ...
    public function update($customerId, $attributes)
    {
        ...
        $this->_validateId($customerId);
        return $this->_doUpdate('put', '/customers/' . $customerId, [
            'customer' => $attributes
        ]);
    }
    ...
    {
        trigger_error("DEPRECATED: Please use TransparentRedirectRequest::url", E_USER_NOTICE);
        return $this->_config->baseUrl() . $this->_config->merchantPath() . '/customers/all/update_via_transparent_redirect_request';
    }
    ...
    public function updateFromTransparentRedirect($queryString)
    {
        trigger_error("DEPRECATED: Please use TransparentRedirectRequest::confirm", E_USER_NOTICE);
        $params = TransparentRedirect::parseAndValidateQueryString($queryString);
        return $this->_doUpdate('post', '/customers/all/confirm_transparent_redirect_request', [
            'id' => $params['id']
        ]);
    }
