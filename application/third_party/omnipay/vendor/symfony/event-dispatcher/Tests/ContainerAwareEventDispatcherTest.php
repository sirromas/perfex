...
class ContainerAwareEventDispatcherTest extends AbstractEventDispatcherTest
{
    ...
    public function testAddAListenerService()
    {
        ...
        $dispatcher->addListenerService('onEvent', array(
            'service.listener',
            'onEvent'
        ));
    ...
    public function testReEnteringAScope()
    {
        ...
        $service1->expects($this->exactly(2))
            ->method('onEvent')
            ->with($event);
    ...
    public function testRemoveAfterDispatch()
    {
        ...
        $dispatcher->removeListener('onEvent', array(
            $container->get('service.listener'),
            'onEvent'
        ));
