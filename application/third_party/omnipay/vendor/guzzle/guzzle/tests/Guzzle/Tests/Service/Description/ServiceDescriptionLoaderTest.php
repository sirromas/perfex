...
class ServiceDescriptionLoaderTest extends \Guzzle\Tests\GuzzleTestCase
{
    ...
    public function testAllowsDeepNestedInheritance()
    {
        ...
        $this->assertEquals('PUT', $d->getOperation('override')
            ->getHttpMethod());
        $this->assertEquals('POST', $d->getOperation('override2')
            ->getHttpMethod());
        $this->assertEquals('/', $d->getOperation('override2')
            ->getUri());
    }
    ...
    public function testAllowsMultipleInheritance()
    {
        ...
        $this->assertTrue($command->getParam('a1')
            ->getRequired());
        $this->assertEquals('bar', $command->getParam('a1')
            ->getDefault());
        $this->assertEquals('test', $command->getParam('a1')
            ->getDescription());
    }
