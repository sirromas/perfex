...
class OauthPluginTest extends \Guzzle\Tests\GuzzleTestCase
{
    ...
    public function testCreatesStringToSignFromPostRequest()
    {
        ...
        '&a%3Db%26c%3Dd%26e%3Df%26oauth_consumer_key%3Dfoo' . '%26oauth_nonce%3De7aa11195ca58349bec8b5ebe351d3497eb9e603%26' . 'oauth_signature_method%3DHMAC-SHA1' . '%26oauth_timestamp%3D' . self::TIMESTAMP . '%26oauth_token%3Dcount%26oauth_version%3D1.0';
    ...
    public function testCreatesStringToSignFromPostRequestWithCustomContentType()
    {
        ...
        $this->assertEquals(
            ...
            'POST&http%3A%2F%2Fwww.test.com%2Fpath' . 
            // Sorted parameters from query string and body
            '&a%3Db%26c%3Dd%26oauth_consumer_key%3Dfoo' . '%26oauth_nonce%3D' . self::NONCE . '%26' . 'oauth_signature_method%3DHMAC-SHA1' . '%26oauth_timestamp%3D' . self::TIMESTAMP . '%26oauth_token%3Dcount%26oauth_version%3D1.0', $p->getStringToSign($request, self::TIMESTAMP, self::NONCE));
    }
...
'POST&http%3A%2F%2Fwww.test.com%2Fpath' . 
        // Sorted parameters from query string and body
        '&a%3Db%26c%3Dd%26e%3Df%26oauth_consumer_key%3Dfoo' . '%26oauth_nonce%3De7aa11195ca58349bec8b5ebe351d3497eb9e603%26' . 'oauth_signature_method%3DHMAC-SHA1' . '%26oauth_timestamp%3D' . self::TIMESTAMP . '%26oauth_version%3D1.0';
