...
interface ClientInterface extends HasDispatcherInterface
{
     ...
     * The Collection result of this method can be
     ...
     * @param array|Collection $headers
     *            HTTP headers
     * @param array|Collection|string|EntityBodyInterface $postBody
     ...
     *            
     * @return \Guzzle\Http\Message\Response|array a single Response or an array of Response objects
     */
