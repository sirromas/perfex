...
class CurlHandle
{
     ...
     *
     * @return resource|null the cURL handle or null if it was closed
     */
    ...
    /**
     * Get the cURL setopt options of the handle.
     * Changing values in the return object will have no effect on the curl
