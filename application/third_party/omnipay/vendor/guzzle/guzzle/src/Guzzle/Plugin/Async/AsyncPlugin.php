...
class AsyncPlugin implements EventSubscriberInterface
{
    ...
    /**
     * Event emitted when a curl progress function is called.
     * When the amount of data uploaded == the amount of data to
    ...
    /**
     * Event emitted when a curl exception occurs.
     * Ignore the exception and set a mock response.
     *
     * @param Event $event            
     */
     ...
     * Add an X-Guzzle-Async header to notify the
