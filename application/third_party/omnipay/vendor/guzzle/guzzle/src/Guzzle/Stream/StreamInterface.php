...
interface StreamInterface
{
     ...
     *            
     * @return string|bool the data read from the stream or FALSE on failure or EOF
     */
     ...
     *            
     * @return int|bool the number of bytes written to the stream on success or FALSE on failure.
     */
