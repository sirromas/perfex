...
class Parameter
{
    ...
    /**
     * Retrieve a known property from the parameter by name or a data property by name.
     * When not specific name value
     ...
     *
     * @param string|array|null $nameOrData
     ...
     *
     * @param OperationInterface|Parameter|null $parent
     ...
     *
     * @param bool|Parameter|null $additional
