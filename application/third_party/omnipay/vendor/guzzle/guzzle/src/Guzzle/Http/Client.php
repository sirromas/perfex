...
class Client extends AbstractHasDispatcher implements ClientInterface
{
     ...
     *
     * @param CurlMultiInterface $curlMulti
     *            Multi object
     *            
     * @return self
     */
    ...
    {
        if (! $this->curlMulti) {
            $this->curlMulti = new CurlMultiProxy(self::MAX_HANDLES, $this->getConfig('select_timeout') ?  : self::DEFAULT_SELECT_TIMEOUT);
        }
