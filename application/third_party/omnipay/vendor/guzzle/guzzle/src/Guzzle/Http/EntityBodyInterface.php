...
interface EntityBodyInterface extends StreamInterface
{
    ...
    /**
     * Specify a custom callback used to rewind a non-seekable stream.
     * This can be useful entity enclosing requests
     * that are redirected.
     *
    ...
    /**
     * If the stream is readable, compress the data in the stream using deflate compression.
     * The uncompressed stream is
    ...
    /**
     * Decompress a deflated string.
     * Once uncompressed, the uncompressed string is then used as the wrapped stream.
     *
     * @param string $filter
     ...
     *
     * @return int|bool the Content-Length or false on failure
     */
     ...
     *            
     * @return bool|string an MD5 string on success or FALSE on failure
     */
