...
class BatchTransferException extends \Exception implements GuzzleException
{
     ...
     * @param TransferStrategy $transferStrategy
     *            The transfer strategy in use when the exception occurred
     * @param DivisorStrategy $divisorStrategy
     *            The divisor strategy in use when the exception occurred
     */
    public function __construct(array $batch, array $transferredItems, \Exception $exception, TransferStrategy $transferStrategy = null, DivisorStrategy $divisorStrategy = null)
    {
        $this->batch = $batch;
