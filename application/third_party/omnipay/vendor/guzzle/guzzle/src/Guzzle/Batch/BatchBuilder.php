...
class BatchBuilder
{
    ...
    /**
     * Automatically flush the batch when the size of the queue reaches a certain threshold.
     * Adds {@see FlushingBatch}.
     *
     * @param $threshold Number
     *            of items to allow in the queue before a flush
     *            
     * @return BatchBuilder
     */
     ...
     * completes, inspect each exception that was thrown.
     * Enables the {@see ExceptionBufferingBatch} decorator.
     *
     * @return BatchBuilder
     */
    ...
    /**
     * Notify a callable each time a batch flush completes.
     * Enables the {@see NotifyingBatch} decorator.
     *
    ...
    /**
     * Configures the batch to transfer batches of requests.
     * Associates a {@see \Guzzle\Http\BatchRequestTransfer}
    ...
    /**
     * Configures the batch to transfer batches commands.
     * Associates as
     ...
     *
     * @param BatchDivisorInterface $divisorStrategy
