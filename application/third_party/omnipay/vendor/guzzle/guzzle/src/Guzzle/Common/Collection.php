...
class Collection implements \ArrayAccess, \IteratorAggregate, \Countable, ToArrayInterface
{
     ...
     *            Key to retrieve.
     *            
     * @return mixed|null of the key or NULL
     */
     ...
     * If a key of the same name has already been added, the key value will be converted into an
     ...
     *            Key to search for
     *            
     * @return bool|string false if not found, otherwise returns the key
     */
     ...
     * one.
     * The Closure should accept three parameters: (string) $key, (string) $value, (array) $context and return a
     * modified value
     *
    ...
    /**
     * Iterates over each key value pair in the collection passing them to the Closure.
     * If the Closure function returns
    ...
    /**
     * Set a value into a nested array key.
    ...
    /**
     * Gets a value from the collection using an array path (e.g.
     * foo/baz/bar would retrieve bar from two nested arrays)
