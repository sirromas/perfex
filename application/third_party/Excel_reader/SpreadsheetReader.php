...
class SpreadsheetReader implements SeekableIterator, Countable
{
     ...
     *            string Path to file
     * @param
     *            string Original filename (in case of an uploaded file), used to determine file type, optional
     * @param
     *            string MIME type from an upload, used to determine file type, optional
     */
     ...
     *
     * @param
     *            TYPE_* Spreadsheet type, one of TYPE_* constants of this class
     */
    ...
    /**
     * Method for SeekableIterator interface.
     * Takes a posiiton and traverses the file to that position
     * The value can be retrieved with a `current()` call afterwards.
     *
     * @param
     *            int Position in file
     */
