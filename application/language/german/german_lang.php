...
$lang['help_project_permissions'] = 'ANSEHEN erlaubt Mitarbeiter, ALLE Projekte anzusehen. Wenn Sie möchten, dass Ihnen nur zugewiesene Projekte (als Mitglieder hinzugefügt) angezeigt werden, vergeben Sie keine ANSEHEN-Rechte.';
$lang['help_tasks_permissions'] = 'ANSEHEN erlaubt Mitarbeiter, ALLE Aufgaben anzusehen. Wenn Sie möchten, dass Ihnen nur zugewiesene Aufgaben oder Aufgaben, denen sie folgen, angezeigt werden, vergeben Sie keine ANSEHEN-Rechte.';
...
$lang['view_permission_auto_checked'] = 'BETRACHEN-Berechtigung automatisch überprüft. Die ANSEHEN-Berechtigung muss auswählt werden, wenn BEARBEITEN, ERSTELLEN und LöSCHEN benutzt werden soll. BEARBEITEN, ERSTELLEN und LöSCHEN können ohne ANSEHEN nicht verwendet werden, weil ANSEHEN eine globale Berechtigung ist, ohne die der Anwender die Daten nicht öffnen und die Aktionen ausführen kann.';
