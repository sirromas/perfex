...
if (get_option('allow_registration') == 1) {
	...
	<div class="col-md-4 col-md-offset-4">
		...
		<div class="form-group">
			<label for="email"><?php echo _l('clients_login_email'); ?></label> <input
				type="text" autofocus="true" class="form-control" name="email"
				id="email">
      ...
      <?php } ?>
		...
		<div class="form-group">
			...
			<?php if(get_option('allow_registration') == 1) { ?>
				<a href="<?php echo site_url('clients/register'); ?>"
