<div class="col-md-12 page-pdf-html-logo">
    ...
    <a
		href="<?php echo admin_url(); ?>estimates/list_estimates/<?php echo $estimate->id; ?>"
		class="btn btn-info pull-right"><?php echo _l('goto_admin_area'); ?>
    </a>
	...
	<div class="panel-body">
		<div class="col-md-10 col-md-offset-1">
			<div class="row">
                ...
                <button type="submit" name="estimatepdf"
						class="btn btn-info" value="estimatepdf">
...
foreach ($estimate->attachments as $attachment) {
        ...
        <div class="col-md-12">
					<b><?php echo _l('estimate_note'); ?></b><br />
					<br /><?php echo $estimate->clientnote; ?>
        </div>
        <?php } ?>
