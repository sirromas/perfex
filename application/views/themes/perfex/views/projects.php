	...
	<div class="panel-body">
        ...
        foreach ($project_statuses as $status) {
         ...
         <div class="col-md-2 border-right">
            ...
            <h3 class="bold">
					<a
						href="<?php echo site_url('clients/projects/'.$status['id']); ?>"><?php echo total_rows('tblprojects',$where); ?></a>
				</h3>
		...
		<div class="table-responsive">
			<table class="table dt-table" data-order-col="2"
               ...
               <tr>
						<td><a
							href="<?php echo site_url('clients/project/'.$project['id']); ?>"><?php echo $project['name']; ?></a></td>
