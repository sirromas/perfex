...
<div class="row">
				...
				<div class="row">
                  ...
                  <div class="form-group">
                        ...
                        <option value="<?php echo $project['id']; ?>"
									...
									<?php if($this->input->get('project_id') == $project['id']){echo ' selected';} ?>><?php echo $project['name']; ?></option>
                        <?php } ?>
                     </select>
						</div>
                  <?php } ?>
                  <div class="row">
                           ...
                           <?php echo form_error('department'); ?>
							...
							<div class="col-md-6">
                              ...
                              <option
											value="<?php echo $priority['priorityid']; ?>"
											<?php echo set_select('priority',$priority['priorityid']); ?>><?php echo ticket_priority_translate($priority['priorityid']); ?></option>
                              <?php } ?>
                           </select>
                ...
                if (get_option('services') == 1 && count($services) > 0) {
                  ...
                  <div class="form-group">
                        ...
                        <option
									...
									<?php echo set_select('service',$service['serviceid'],(count($services) == 1 ? true : false)); ?>><?php echo $service['name']; ?></option>
                        <?php } ?>
                     </select>
						</div>
                  <?php } ?>
	...
	<div class="col-md-12 text-center mtop20">
		<button type="submit" class="btn btn-info"
			data-form="#open-new-ticket-form" autocomplete="off"
