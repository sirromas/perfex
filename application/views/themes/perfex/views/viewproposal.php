...
<div class="row mtop15">
	<div class="col-md-6 col-md-offset-6">
        ...
        <tr>
					<td><span class="bold"><?php echo _l('estimate_discount'); ?> (<?php echo _format_number($proposal->discount_percent,true); ?>%)</span>
					</td>
					<td class="discount">
        ...
        <?php } ?>
        <tr>
					<td><span class="bold"><?php echo _l('estimate_total'); ?></span></td>
					<td class="total">
...
<div id="proposal-wrapper">
	<div class="row proposal-wrapper">
		<div class="col-md-9 proposal-left tc-content">
			<div class="row">
		...
		<div class="col-md-3 proposal-right">
          ...
          <a
						href="<?php echo admin_url('proposals/list_proposals/'.$proposal->id); ?>"
...
if (($proposal->status != 2 && $proposal->status != 3)) {
              ...
              <button type="submit"
						...
						autocomplete="off" class="btn btn-success btn-block"><?php echo _l('proposal_accept_info'); ?></button>
              <?php echo form_hidden('action','accept_proposal'); ?>
              <?php echo form_close(); ?>
              <?php echo form_open($this->uri->uri_string()); ?>
              <button type="submit"
						data-loading-text="<?php echo _l('wait_text'); ?>"
						autocomplete="off" class="btn btn-danger btn-block mtop10"><?php echo _l('proposal_decline_info'); ?></button>
            ...
            ?>
              ...
              <button type="submit"
						...
						<i class="fa fa-file-pdf-o"></i> <?php echo _l('proposal_pdf_info'); ?></button>
          ...
          <div class="clearfix"></div>
            ...
            <div class="proposal-comment">
						<textarea name="content" id="content" rows="4"
							class="form-control mtop15"></textarea>
