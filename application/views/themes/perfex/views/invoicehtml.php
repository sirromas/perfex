<div class="col-md-12 page-pdf-html-logo">
    ...
    <a
		href="<?php echo admin_url(); ?>invoices/list_invoices/<?php echo $invoice->id; ?>"
		class="btn btn-info pull-right"><?php echo _l('goto_admin_area'); ?></a>
    <?php } else if(is_client_logged_in() && has_contact_permission('invoices')){ ?>
    <a href="<?php echo site_url('clients/invoices/'); ?>"
		class="btn btn-info pull-right"><?php echo _l('client_go_to_dashboard'); ?></a>
    <?php } ?>
</div>
		...
		<div class="col-md-10 col-md-offset-1">
			<div class="row">
				...
				<div class="col-md-6 text-right _buttons">
                    ...
                    <a href="#"
						class="btn btn-success pull-right mleft5 pay-now-top"><?php echo _l('invoice_html_online_payment_button_text'); ?></a>
                    <?php } ?>
                    <?php echo form_open($this->uri->uri_string()); ?>
                    <button type="submit" name="invoicepdf"
						value="invoicepdf" class="btn btn-info">
...
foreach ($invoice->attachments as $attachment) {
                ...
                <div class="col-md-12">
					<b><?php echo _l('invoice_note'); ?></b><br />
					<br /><?php echo $invoice->clientnote; ?>
                </div>
                <?php } ?>
                ...
                <p class="bold mbot15 font-medium"><?php echo _l('invoice_received_payments'); ?></p>
					<table class="table table-hover">
                        ...
                        <tr>
								<td><span class="pull-left"><?php echo $payment['paymentid']; ?></span>
                                <?php echo form_open($this->uri->uri_string()); ?>
                                <button type="submit"
										value="<?php echo $payment['paymentid']; ?>"
...
foreach ($payment_modes as $mode) {
                        if (! is_numeric($mode['id']) && ! empty($mode['id'])) {
                            ...
                            ?>
                                    <div
								class="radio radio-success online-payment-radio">
								<input type="radio" value="<?php echo $mode['id']; ?>"
									id="pm_<?php echo $mode['id']; ?>" name="paymentmode"> <label
									for="pm_<?php echo $mode['id']; ?>"><?php echo $mode['name']; ?></label>
							</div>
                            ...
                            <div class="form-group mtop25">
								...
								<div class="input-group">
									<input type="number" required
										max="<?php echo get_invoice_total_left_to_pay($invoice->id,$invoice->total); ?>"
										data-total="<?php echo get_invoice_total_left_to_pay($invoice->id,$invoice->total); ?>"
										name="amount" class="form-control"
										value="<?php echo get_invoice_total_left_to_pay($invoice->id,$invoice->total); ?>">
                    ...
                    ?>
							...
							<input type="submit" name="make_payment" class="btn btn-success"
                    ...
                    <div
							class="<?php if($found_online_mode == true){echo 'col-md-6 text-right';}else{echo 'col-md-12';};?>">
