                        ...
                        <div class="col-md-6 text-left">
                            ...
                            <div class="form-group mtop25">
                                ...
                                <div class="input-group">
                                    <input type="number" required max="<?php echo get_invoice_total_left_to_pay($invoice->id,$invoice->total); ?>" data-total="<?php echo get_invoice_total_left_to_pay($invoice->id,$invoice->total); ?>" name="amount" class="form-control" value="<?php echo get_invoice_total_left_to_pay($invoice->id,$invoice->total); ?>">
