            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="billing_street" id="billing_street" value="<?php echo $client->billing_street; ?>">
                    </div>
                    <div class="form-group">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="shipping_street" id="shipping_street" value="<?php echo $client->shipping_street; ?>">
                    </div>
                    <div class="form-group">
