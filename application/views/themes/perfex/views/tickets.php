	...
	<div class="panel-body">
		<div class="row">
			<div class="col-md-12">
				...
				<a href="<?php echo site_url('clients/open_ticket'); ?>"
					class="btn btn-info pull-right"><?php echo _l('clients_ticket_open_subject'); ?></a>
        ...
        <div class="col-md-2 border-right">
           ...
           <?php
            ...
            ?>
          <a
						href="<?php echo site_url('clients/tickets/'.$status['ticketstatusid']); ?>">
