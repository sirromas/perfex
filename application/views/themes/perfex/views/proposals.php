	...
	<div class="panel-body">
		<div class="table-responsive">
			<table class="table dt-table" data-order-col="3"
              ...
              <tr>
						<td><a
							href="<?php echo site_url('viewproposal/'.$proposal['id'].'/'.$proposal['hash']); ?>"><?php echo format_proposal_number($proposal['id']); ?></a>
						
						<td><a
							href="<?php echo site_url('viewproposal/'.$proposal['id'].'/'.$proposal['hash']); ?>"><?php echo $proposal['subject']; ?></a>
                    <?php
