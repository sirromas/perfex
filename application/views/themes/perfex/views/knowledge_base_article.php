...
<div class="panel_s">
	<div class="panel-body">
		<div class="row kb-article">
			<div
				class="col-md-<?php if(count($related_articles) == 0){echo '12';}else{echo '8';} ?>">
				...
				<ul class="mtop10 articles_list">
						...
						<li><a
						href="<?php echo site_url('knowledge_base/'.$relatedArticle['slug']); ?>"
						class="article-heading"><?php echo $relatedArticle['subject']; ?></a>
