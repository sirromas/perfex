...
<div class="panel_s">
    ...
    <div class="table-responsive mtop15">
			<table class="table dt-table" data-order-col="1"
            ...
            if (! isset($file['external'])) {
                ...
                $img_url = site_url('download/preview_image?path=' . protected_file_url_by_path($path) . '&type=' . $file['filetype']);
            } else 
                if (isset($file['external']) && ! empty($file['external'])) {
            ...
            ?>
                <a href="<?php echo $attachment_url; ?>"
                    ...
                    <?php } else { ?>
                    <i
								class="<?php echo get_mime_class($file['filetype']); ?>"></i> <?php echo $file['file_name']; ?>
                    <?php } ?>
                </a>
            ...
            <td>
                ...
                <a
							href="<?php echo site_url('clients/delete_file/'.$file['id'].'/general'); ?>"
