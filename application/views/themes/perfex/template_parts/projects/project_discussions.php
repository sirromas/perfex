...
<a href="#" onclick="new_discussion();return false;"
	class="btn btn-info mtop5"><?php echo _l('new_project_discussion'); ?></a>
<hr />
<!-- Miles Stones -->
...
<div class="table-responsive">
	<table class="table dt-table" data-order-col="1" data-order-type="desc">
		...
		<tbody>
            ...
            <tr>
				<td><a
					href="<?php echo site_url('clients/project/'.$project->id.'?group='.$group.'&discussion_id='.$discussion['id']); ?>"><?php echo $discussion['subject']; ?></a></td>
