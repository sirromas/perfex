...
$value = get_custom_field_value($project->id, $field['id'], 'projects');
  ...
  <?php } ?>
	...
	<div class="col-md-6 text-center">
		...
		<div class="project-progress relative mtop30" data-thickness="22"
			data-reverse="true" data-size="170"
...
<div class="col-md-12 project-overview-column">
    ...
    <?php } ?>
		...
		<div class="row">
			<div class="col-md-3">
				<p class="text-uppercase text-muted"><?php echo _l('project_overview_expenses'); ?></span>
				</p>
			...
			<div class="col-md-3">
				<p class="text-uppercase text-info"><?php echo _l('project_overview_expenses_billable'); ?></span>
				</p>
			...
			<div class="col-md-3">
				<p class="text-uppercase text-success"><?php echo _l('project_overview_expenses_billed'); ?></span>
				</p>
			...
			<div class="col-md-3">
				<p class="text-uppercase text-danger"><?php echo _l('project_overview_expenses_unbilled'); ?></span>
				</p>
...
<div class="col-md-12">
	...
	<div class="clearfix"></div>
	<div
		class="col-md-<?php if($project->settings->view_team_members == 1){ echo 6; } else {echo 12;} ?>">
