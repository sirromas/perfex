...
<div class="table-responsive">
	<table class="table dt-table" data-order-col="1" data-order-type="desc">
        ...
        <tr>
				<td data-order="<?php echo $estimate['number']; ?>"><a
					href="<?php echo site_url('viewestimate/' . $estimate['id'] . '/' . $estimate['hash']); ?>"><?php echo format_estimate_number($estimate['id']); ?></a></td>
