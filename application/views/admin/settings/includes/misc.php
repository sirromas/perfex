...
<ul class="nav nav-tabs" role="tablist">
	<li role="presentation" class="active"><a href="#misc"
		aria-controls="misc" role="tab" data-toggle="tab"><?php echo _l('settings_group_misc'); ?></a>
	</li>
	<li role="presentation"><a href="#set_newsfeed"
		aria-controls="set_newsfeed" role="tab" data-toggle="tab"><?php echo _l('settings_group_newsfeed'); ?></a>
	</li>
	<li role="presentation"><a href="#set_recaptcha"
		aria-controls="set_recaptcha" role="tab" data-toggle="tab"><?php echo _l('re_captcha'); ?></a>
	</li>
</ul>
...
<div class="tab-content mtop30">
	<div role="tabpanel" class="tab-pane active" id="misc">
		...
		<i class="fa fa-question-circle" data-toggle="tooltip"
			data-title="<?php echo _l('scroll_responsive_tables_help'); ?>"></i>
        <?php echo render_yes_no_option('scroll_responsive_tables','scroll_responsive_tables'); ?>
        <hr />
		<i class="fa fa-question-circle" data-toggle="tooltip"
			data-title="<?php echo _l('text_not_recommended_for_servers_limited_resources'); ?>"></i>
        <?php
        $params = array();
		...
		<div class="form-group">
			...
			<div class="radio radio-primary">
				<input type="radio" id="stbxb_all"
					name="settings[show_table_export_button]" value="to_all"
					<?php if(get_option('show_table_export_button') == 'to_all'){echo ' checked';} ?>>
				<label for="stbxb_all"><?php echo _l('show_table_export_all'); ?></label>
			</div>

			<div class="radio radio-primary">
				<input type="radio" id="stbxb_admins"
					name="settings[show_table_export_button]" value="only_admins"
					<?php if(get_option('show_table_export_button') == 'only_admins'){echo ' checked';} ?>>
				<label for="stbxb_admins"><?php echo _l('show_table_export_admins'); ?></label>

			</div>
			<div class="radio radio-primary">
				<input type="radio" id="stbxb_hide"
					name="settings[show_table_export_button]" value="hide"
					<?php if(get_option('show_table_export_button') == 'hide'){echo ' checked';} ?>>
