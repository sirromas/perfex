<ul class="nav nav-tabs" role="tablist">
	<li role="presentation" class="active"><a href="#set_tickets_general"
		aria-controls="set_tickets_general" role="tab" data-toggle="tab"><?php echo _l('settings_group_general'); ?></a>
	</li>
	<li role="presentation"><a href="#set_tickets_piping"
		aria-controls="set_tickets_piping" role="tab" data-toggle="tab"><?php echo _l('tickets_piping'); ?></a>
	</li>
	<li role="presentation"><a href="#ticket_form"
		aria-controls="ticket_form" role="tab" data-toggle="tab"><?php echo _l('ticket_form'); ?></a>
	</li>
</ul>
<div class="tab-content mtop30">
    ...
    <hr />
		<i class="fa fa-question-circle" data-toggle="tooltip"
			data-title="<?php echo _l('receive_notification_on_new_ticket_help'); ?>"></i>
    <?php render_yes_no_option('receive_notification_on_new_ticket','receive_notification_on_new_ticket'); ?>
    <hr />
		<i class="fa fa-question-circle" data-toggle="tooltip"
			data-title="<?php echo _l('staff_members_open_tickets_to_all_contacts_help'); ?>"></i>
	...
	<div role="tabpanel" class="tab-pane" id="set_tickets_piping">
		...
		<code><?php echo FCPATH .'pipe.php'; ?></code>
		<hr />
	...
	<div role="tabpanel" class="tab-pane" id="ticket_form">
		...
		<p>
			<b>Form url:</b> <a href="<?php echo site_url('forms/ticket'); ?>"
				target="_blank">
        <?php echo site_url('forms/ticket'); ?>
      </a>
		</p>
		<p>
			<b>Form file location:</b>
			<code><?php echo VIEWPATH.'forms\ticket.php'; ?></code>
		</p>
		<hr />
		...
		<textarea readonly class="form-control" rows="5">
			<iframe width="600" height="850"
				src="<?php echo site_url('forms/ticket'); ?>" frameborder="0"
				allowfullscreen></iframe>
		</textarea>
		<p class="bold mtop15">When placing the iframe snippet code consider
			the following:</p>
		<p
			class="<?php if(strpos(site_url(),'http://') !== false){echo 'bold text-success';} ?>">1.
			If the protocol of your installation is http use a http page inside
			the iframe.</p>
		<p
			class="<?php if(strpos(site_url(),'https://') !== false){echo 'bold text-success';} ?>">2.
			If the protocol of your installation is https use a https page inside
			the iframe.</p>
		<p>None SSL installation will need to place the link in non ssl eq.
			landing page and backwards.</p>
		<hr />
		<h4 class="bold">Change form container column (Bootstrap)</h4>
		<p>
			<a href="<?php echo site_url('forms/ticket?col=col-md-8'); ?>"
				target="_blank">
		...
		<p>
			<a
				href="<?php echo site_url('forms/ticket?col=col-md-8+col-md-offset-2'); ?>"
				target="_blank"><?php echo site_url('forms/ticket?col=col-md-8+col-md-offset-2'); ?></a>
		</p>
		<p>
			<a href="<?php echo site_url('forms/ticket?col=col-md-5'); ?>"
				target="_blank">
