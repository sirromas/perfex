<div class="row">
	...
	<div class="col-md-6 text-center">
		<div
			class="alert alert-<?php if($latest_version > $current_version){echo 'danger';}else {echo 'info';} ?>">
	...
	<div class="col-md-6 text-center">
		<div
			class="alert alert-<?php if($latest_version > $current_version){echo 'success';} else if($latest_version == $current_version){echo 'info';} ?>">
	...
	<div class="col-md-12 text-center">
      ...
      <div class="alert alert-warning">
			Before performing an update, it is <b>strongly recommended to create
				a full backup</b> of your current installation <b>(files and
				database)</b> and review the changelog.
		</div>
		<h3 class="bold text-center mbot20">
			<i class="fa fa-exclamation-circle" aria-hidden="true"></i> <?php echo _l('update_available'); ?></h3>
		<div class="update_app_wrapper"
			data-wait-text="<?php echo _l('wait_text'); ?>"
			data-original-text="<?php echo _l('update_now'); ?>">
         <?php if(count($update_errors) == 0){ ?>
         <a href="#" id="update_app" class="btn btn-success">Download
				files</a>
         <?php } ?>
      </div>
      ...
      <h3 class="bold mbot20 text-success">
			<i class="fa fa-exclamation-circle" aria-hidden="true"></i> <?php echo _l('using_latest_version'); ?></h3>
      <?php } ?>
      <?php if(count($update_errors) > 0){ ?>
...
if (isset($update_info->additional_data)) {
