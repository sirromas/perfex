...
<ul class="nav nav-tabs" role="tablist">
	<li role="presentation" class="active"><a href="#general"
		aria-controls="general" role="tab" data-toggle="tab"><?php echo _l('settings_sales_heading_general'); ?></a>
	</li>
	<li role="presentation"><a href="#invoice" aria-controls="invoice"
		role="tab" data-toggle="tab"><?php echo _l('settings_sales_heading_invoice'); ?></a>
	</li>
	<li role="presentation"><a href="#estimates" aria-controls="estimates"
		role="tab" data-toggle="tab"><?php echo _l('settings_sales_heading_estimates'); ?></a>
	</li>
	<li role="presentation"><a href="#set_proposals"
		aria-controls="set_proposals" role="tab" data-toggle="tab"><?php echo _l('proposals'); ?></a>
	</li>
...
<div class="tab-content">
	<div role="tabpanel" class="tab-pane active" id="general">
		...
		<div class="row">
			<div class="col-md-6">
				<div class="form-group">
					...
					<select id="decimal_separator" class="selectpicker"
						name="settings[decimal_separator]" data-width="100%">
						<option value=","
							<?php if(get_option('decimal_separator') == ','){echo ' selected';}; ?>>,</option>
						<option value="."
							<?php if(get_option('decimal_separator') == '.'){echo ' selected';}; ?>>.</option>
					</select>
				</div>
			...
			<div class="col-md-6">
				<div class="form-group">
					...
					<select id="thousand_separator" class="selectpicker"
						name="settings[thousand_separator]" data-width="100%">
						<option value=","
							<?php if(get_option('thousand_separator') == ','){echo ' selected';}; ?>>,</option>
						<option value="."
							<?php if(get_option('thousand_separator') == '.'){echo ' selected';}; ?>>.</option>
					</select>
				</div>
		...
		<hr />
		<i class="fa fa-question-circle" data-toggle="tooltip"
			data-title="<?php echo _l('remove_tax_name_from_item_table_help'); ?>"></i>
		...
		<div class="form-group">
			...
			<div class="radio radio-primary radio-inline">
				<input type="radio" name="settings[currency_placement]"
					value="before" id="c_placement_before"
					<?php if(get_option('currency_placement') == 'before'){echo 'checked';} ?>>
				<label for="c_placement_before"><?php echo _l('settings_sales_currency_placement_before'); ?> ( $25.00 ) </label>
			</div>
			<div class="radio radio-primary radio-inline">
				<input type="radio" name="settings[currency_placement]"
					id="c_placement_after" value="after"
					<?php if(get_option('currency_placement') == 'after'){echo 'checked';} ?>>
...
?>
	...
	<div role="tabpanel" class="tab-pane" id="invoice">
		...
		<hr />
		<i class="fa fa-question-circle" data-toggle="tooltip"
			data-title="<?php echo _l('settings_sales_decrement_invoice_number_on_delete_tooltip'); ?>"></i>
		...
		<div class="form-group">
			...
			<div class="radio radio-primary radio-inline">
				<input type="radio" id="number_based"
					name="settings[invoice_number_format]" value="1"
					<?php if(get_option('invoice_number_format') == '1'){echo 'checked';} ?>>
				<label for="number_based"><?php echo _l('settings_sales_invoice_number_format_number_based'); ?></label>
			</div>
			<div class="radio radio-primary radio-inline">
				<input type="radio" name="settings[invoice_number_format]" value="2"
					id="year_based"
					<?php if(get_option('invoice_number_format') == '2'){echo 'checked';} ?>>
	...
	<div role="tabpanel" class="tab-pane" id="estimates">
		<div class="form-group">
			...
			<input type="text" name="settings[estimate_prefix]"
				class="form-control"
		...
		<hr />
		<i class="fa fa-question-circle" data-toggle="tooltip"
			data-title="<?php echo _l('settings_sales_decrement_estimate_number_on_delete_tooltip'); ?>"></i>
		...
		<div class="form-group">
			...
			<div class="radio radio-primary radio-inline">
				<input type="radio" name="settings[estimate_number_format]"
					value="1" id="e_number_based"
					<?php if(get_option('estimate_number_format') == '1'){echo 'checked';} ?>>
				<label for="e_number_based"><?php echo _l('settings_sales_estimate_number_format_number_based'); ?></label>
			</div>
			<div class="radio radio-primary radio-inline">
				<input type="radio" name="settings[estimate_number_format]"
					value="2" id="e_year_based"
					<?php if(get_option('estimate_number_format') == '2'){echo 'checked';} ?>>
		...
		<div class="row">
			...
			<div class="col-md-7">
				...
				<select name="settings[default_estimates_pipeline_sort]"
					id="default_estimates_pipeline_sort" class="selectpicker"
					data-width="100%"
					data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>">
					<option value=""></option>
					<option value="datecreated"
						<?php if(get_option('default_estimates_pipeline_sort') == 'datecreated'){echo 'selected'; }?>><?php echo _l('estimates_sort_datecreated'); ?></option>
					<option value="date"
						<?php if(get_option('default_estimates_pipeline_sort') == 'date'){echo 'selected'; }?>><?php echo _l('estimates_sort_estimate_date'); ?></option>
					<option value="pipeline_order"
						<?php if(get_option('default_estimates_pipeline_sort') == 'pipeline_order'){echo 'selected'; }?>><?php echo _l('estimates_sort_pipeline'); ?></option>
					<option value="expirydate"
						<?php if(get_option('default_estimates_pipeline_sort') == 'expirydate'){echo 'selected'; }?>><?php echo _l('estimates_sort_expiry_date'); ?></option>
				</select>
			</div>
			<div class="col-md-5">
				<div class="mtop30 text-right">
					<div class="radio radio-inline radio-primary">
						<input type="radio" id="k_desc_estimate"
							name="settings[default_estimates_pipeline_sort_type]" value="asc"
							<?php if(get_option('default_estimates_pipeline_sort_type') == 'asc'){echo 'checked';} ?>>
						<label for="k_desc_estimate"><?php echo _l('order_ascending'); ?></label>
					</div>
					<div class="radio radio-inline radio-primary">
						<input type="radio" id="k_asc_estimate"
							name="settings[default_estimates_pipeline_sort_type]"
							value="desc"
							<?php if(get_option('default_estimates_pipeline_sort_type') == 'desc'){echo 'checked';} ?>>
	...
	<div role="tabpanel" class="tab-pane" id="set_proposals">
		...
		<div class="row">
			...
			<div class="col-md-7">
				<label for="default_proposals_pipeline_sort" class="control-label"><?php echo _l('default_pipeline_sort'); ?></label>
				<select name="settings[default_proposals_pipeline_sort]"
					id="default_proposals_pipeline_sort" class="selectpicker"
					data-width="100%"
					data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>">
					<option value=""></option>
					<option value="datecreated"
						<?php if(get_option('default_proposals_pipeline_sort') == 'datecreated'){echo 'selected'; }?>><?php echo _l('proposals_sort_datecreated'); ?></option>
					<option value="date"
						<?php if(get_option('default_proposals_pipeline_sort') == 'date'){echo 'selected'; }?>><?php echo _l('proposals_sort_proposal_date'); ?></option>
					<option value="pipeline_order"
						<?php if(get_option('default_proposals_pipeline_sort') == 'pipeline_order'){echo 'selected'; }?>><?php echo _l('proposals_sort_pipeline'); ?></option>
					<option value="open_till"
						<?php if(get_option('default_proposals_pipeline_sort') == 'open_till'){echo 'selected'; }?>><?php echo _l('proposals_sort_open_till'); ?></option>
				</select>
			</div>
			<div class="col-md-5">
				<div class="mtop30 text-right">
					<div class="radio radio-inline radio-primary">
						<input type="radio" id="k_desc_proposal"
							name="settings[default_proposals_pipeline_sort_type]" value="asc"
							<?php if(get_option('default_proposals_pipeline_sort_type') == 'asc'){echo 'checked';} ?>>
						<label for="k_desc_proposal"><?php echo _l('order_ascending'); ?></label>
					</div>
					<div class="radio radio-inline radio-primary">
						<input type="radio" id="k_asc_proposal"
							name="settings[default_proposals_pipeline_sort_type]"
							value="desc"
							<?php if(get_option('default_proposals_pipeline_sort_type') == 'desc'){echo 'checked';} ?>>
