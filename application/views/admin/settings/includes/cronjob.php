...
<div class="tab-content">
  ...
  <div role="tabpanel" class="tab-pane" id="tasks">
   <i class="fa fa-question-circle" data-toggle="tooltip" data-title="<?php echo _l('tasks_reminder_notification_before_help'); ?>"></i>
 ...
 <div role="tabpanel" class="tab-pane" id="contracts">
  ...
  <hr />
   <i class="fa fa-question-circle" data-toggle="tooltip" data-title="<?php echo _l('settings_reminders_contracts_tooltip'); ?>"></i>
...
<div role="tabpanel" class="tab-pane" id="surveys">
 <i class="fa fa-question-circle" data-toggle="tooltip" data-title="<?php echo _l('settings_survey_send_emails_per_cron_run_tooltip'); ?>"></i>
...
<div role="tablpanel" class="tab-pane" id="expenses">
 <i class="fa fa-question-circle" data-toggle="tooltip" data-title="<?php echo _l('hour_of_day_perform_auto_operations_format'); ?>"></i>
