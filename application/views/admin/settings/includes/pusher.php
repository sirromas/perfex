...
<i class="fa fa-question-circle" data-toggle="tooltip"
	data-title="<?php echo _l('pusher_cluster_notice'); ?>"></i>
...
<i class="fa fa-question-circle" data-toggle="tooltip"
	data-title="Starting from September 2017 the application must run on SSL in order desktop notifications to work properly (browsers requires SSL)."></i>
