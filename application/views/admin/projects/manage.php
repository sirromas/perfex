			...
			<div class="col-md-12">
              ...
              <div
                ...
                if (has_permission('projects', '', 'view')) {
                    ?>
                  <li><a href="#" data-cview="my_projects"
                ...
                foreach ($statuses as $status) {
                    ...
                    ?>
                   <?php echo form_hidden('project_status_'.$status['id'],$value); ?>
...
<script>
 ...
 initDataTable('.table-projects', window.location.href, [projects_not_sortable], [projects_not_sortable], ProjectsServerParams, <?php echo do_action('projects_table_default_order',json_encode(array(5,'ASC'))); ?>);
</script>
</body>
</html>
