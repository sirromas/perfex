							...
							<div class="col-md-12">
								<div class="form-group">
									<label for="tags" class="control-label"><i class="fa fa-tag"
										...
										type="text" class="tagsinput" id="tags" name="tags" value=""
										data-role="tagsinput">
									<hr class="no-mtop" />
								</div>
							</div>
						...
						<div class="row">
							<div class="col-md-12">
								<div class="row">
									...
									<div class="col-md-9">
										<select name="timesheet_task_id" id="timesheet_task_id"
...
$has_permission_create = has_permission('projects', '', 'create');
                                            foreach ($tasks as $task) {
                                                if ($task['billed'] == 1 || (! $has_permission_create && ! $this->tasks_model->is_task_assignee(get_staff_user_id(), $task['id']) || $task['status'] == 5)) {
                                                    continue;
                                                }
						...
						<div class="row mtop15">
							<div class="col-md-12">
								<div class="row">
									...
									<div class="col-md-9">
										<select name="timesheet_staff_id" id="timesheet_staff_id"
											class="selectpicker" data-live-search="true"
											data-width="100%" data-none-selected-text="-">
											<option value=""></option>
										</select>
