...
<div id="wrapper">
	<div class="content">
     ...
     <?php } ?>
     <div
				class="col-md-5<?php if($this->input->get('notifications')){echo ' hide';} ?>">
				<div class="panel_s">
          ...
          <div class="button-group mtop10 pull-right">
           <?php if(!empty($staff_p->facebook)){ ?>
            <a href="<?php echo $staff_p->facebook; ?>" target="_blank"
								class="btn btn-default btn-icon"><i class="fa fa-facebook"></i></a>
            <?php } ?>
            <?php if(!empty($staff_p->linkedin)){ ?>
            <a href="<?php echo $staff_p->linkedin; ?>"
								class="btn btn-default btn-icon"><i class="fa fa-linkedin"></i></a>
            <?php } ?>
            <?php if(!empty($staff_p->skype)){ ?>
            <a href="skype:<?php echo $staff_p->skype; ?>"
								data-toggle="tooltip" title="<?php echo $staff_p->skype; ?>"
								target="_blank" class="btn btn-default btn-icon"><i
								class="fa fa-skype"></i></a>
            <?php } ?>
            <?php if(has_permission('staff','','edit')){ ?>
            <a
								href="<?php echo admin_url('staff/member/'.$staff_p->staffid); ?>"
          ...
          <div class="profile mtop20 display-inline-block">
            ...
            <?php echo $staff_p->firstname . ' ' . $staff_p->lastname; ?>
              ...
              <small> - <?php echo _l('last_active'); ?>: <?php echo time_ago($staff_p->last_activity); ?></small>
            <?php } ?>
            </h4>
							<p class="display-block">
								<i class="fa fa-envelope"></i> <a
									href="mailto:<?php echo $staff_p->email; ?>"><?php echo $staff_p->email; ?></a>
							</p>
            <?php if($staff_p->phonenumber != ''){ ?>
            <p>
								<i class="fa fa-phone-square"></i> <?php echo $staff_p->phonenumber; ?></p>
            <?php } ?>
   ...
   <div
				class="col-md-7<?php if($this->input->get('notifications')){echo ' col-md-offset-2';} ?>">
				<div class="panel_s">
					<div class="panel-body">
						<h4 class="no-margin">
