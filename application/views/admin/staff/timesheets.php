     ...
     <div class="col-md-12">
          ...
          <div class="alert alert-info alert-dismissible" role="alert">
							<button type="button" class="close"
								onclick="window.location.href= '<?php echo admin_url('misc/dismiss_timesheets_notice_admins'); ?>';"
          ...
          <?php } ?>
          <a
							href="<?php echo site_url($this->uri->uri_string().(!isset($view_all) ? '?view=all' : '')); ?>"
							class="btn btn-info"><i class="fa fa-clock-o"></i>
            <?php
            ...
            ?>
						...
						<hr />
          <?php } ?>
          <canvas id="timesheetsChart" style="max-height: 400px;"
							width="350" height="350"></canvas>
						<hr />
        ...
        <?php if(isset($view_all)){ ?>
        <div class="col-md-3">
								<select name="staff_id" id="staff_id" class="selectpicker"
									data-width="100%">
       ...
       <?php } ?>
       <div class="col-md-3">
								<select data-empty-title="<?php echo _l('project'); ?>"
							...
							<div class="col-md-3">
								<a href="#" id="apply_filters_timesheets"
									class="btn btn-default p7"><?php echo _l('apply'); ?></a>
							</div>
							<div class="mtop10 hide relative pull-right"
								id="group_by_tasks_wrapper">
								<span><?php echo _l('group_by_task'); ?></span>
								<div class="onoffswitch">
									<input type="checkbox" name="group_by_task"
										class="onoffswitch-checkbox" id="group_by_task"> <label
										class="onoffswitch-label" for="group_by_task"></label>
								</div>
							</div>
							<div class="col-md-12">
								<hr class="no-mtop" />
