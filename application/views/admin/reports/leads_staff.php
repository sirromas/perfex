        ...
        <div class="row">
            <div class="col-md-12">
                <p class="text-info inline-block" data-placement="bottom" data-toggle="tooltip"
                   data-title="<?php echo _l('leads_report_converted_notice'); ?>"><i class="fa fa-question-circle"></i>
                </p>
                <div class="panel_s">
                            ...
                            <?php if (count($regions) > 0) { ?>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="l_regions"><?php echo _l('regions'); ?></label>
                                        <select name="l_regions" id="l_regions" class="selectpicker"
                                                data-width="100%">
