						...
						<div class="row">
							<div class="col-md-3">
								<select class="selectpicker" name="report-group-change"
                                    ...
                                    <option
										value="<?php echo $group['groupid']; ?>"><?php echo $group['name']; ?></option>
                                    <?php } ?>
                                </select>
							</div>
						</div>
...
foreach ($group['articles'] as $article) {
                            $total_answers = total_rows('tblknowledgebasearticleanswers', array(
                                'articleid' => $article['articleid']
                            ));
                            $total_yes_answers = total_rows('tblknowledgebasearticleanswers', array(
                                'articleid' => $article['articleid'],
                                'answer' => 1
                            ));
                            $total_no_answers = total_rows('tblknowledgebasearticleanswers', array(
                                'articleid' => $article['articleid'],
                                'answer' => 0
                            ));
                            $percent_yes = 0;
                            ...
                            ?>
									...
									<div class="col-md-12">
										<div class="row">
                                            ...
                                            <div
										class="col-md-12 progress-bars-report-articles">
										<div class="progress">
											<div
												class="progress-bar progress-bar-info progress-bar-striped"
												role="progressbar" aria-valuenow="40" aria-valuemin="0"
												aria-valuemax="100" style="width: 0%"
												data-percent="<?php echo $percent_yes; ?>">0%</div>
										</div>
										<div class="row">
										...
										<div class="progress">
											<div
												...
												role="progressbar" aria-valuenow="40" aria-valuemin="0"
												aria-valuemax="100" style="width: 0%"
												data-percent="<?php echo $percent_no; ?>">0%</div>
										</div>
									</div>
                                            <?php } else { ?>
                                            <div class="col-md-12">
