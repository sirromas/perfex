<div id="proposals-reports" class="hide">
	<div class="row">
		<div class="col-md-4">
			<div class="form-group">
				...
				<select name="proposal_status" class="selectpicker" multiple
					data-width="100%">
   ...
   <div class="col-md-4">
			<div class="form-group">
				...
				<select name="proposals_sale_agents" class="selectpicker" multiple
					data-width="100%">
					<option value="" selected><?php echo _l('invoice_status_report_all'); ?></option>
   ...
   <?php } ?>
	...
	<table
		class="table table-striped table-proposals-report scroll-responsive">
		<thead>
			<tr>
