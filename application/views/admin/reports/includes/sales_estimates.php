...
<div id="estimates-report" class="hide">
	<div class="row">
		<div class="col-md-4">
			<div class="form-group">
				...
				<select name="estimate_status" class="selectpicker" multiple
					data-width="100%">
      ...
      <div class="col-md-4">
			<div class="form-group">
				...
				<select name="sale_agent_estimates" class="selectpicker" multiple
					data-width="100%">
					<option value="" selected><?php echo _l('invoice_status_report_all'); ?></option>
	...
	<table
		class="table table-striped table-estimates-report scroll-responsive">
		<thead>
			<tr>
