                    ...
                    <table class="table dt-table scroll-responsive">
                            ...
                            <tr>
									...
									<td><a href="#"
										...
										href="<?php echo admin_url('leads/delete_source/'.$source['id']); ?>"
        ...
        <div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title">
					<span class="edit-title"><?php echo _l('edit_source'); ?></span> <span
						class="add-title"><?php echo _l('lead_new_source'); ?></span>
				</h4>
			</div>
