...
?>
   <div class="top-lead-menu">
		<ul class="nav nav-tabs<?php if(!isset($lead)){echo ' lead-new';} ?>"
			role="tablist">
			<li role="presentation" class="active"><a href="#tab_lead_profile"
				aria-controls="tab_lead_profile" role="tab" data-toggle="tab">
            <?php echo _l('lead_profile'); ?>
            </a></li>
         <?php if(isset($lead)){ ?>
         <?php if(count($mail_activity) > 0 || isset($show_email_activity)){ ?>
         <li role="presentation"><a href="#tab_email_activity"
				aria-controls="tab_email_activity" role="tab" data-toggle="tab">
            <?php echo _l('lead_email_activity'); ?>
            </a></li>
         <?php } ?>
         <li role="presentation"><a href="#tab_proposals_leads"
			...
			<li role="presentation"><a href="#tab_tasks_leads"
			...
			<li role="presentation"><a href="#attachments"
				aria-controls="attachments" role="tab" data-toggle="tab">
            <?php echo _l('lead_attachments'); ?>
            </a></li>
			<li role="presentation"><a href="#lead_reminders"
				onclick="initDataTable('.table-reminders-leads', admin_url + 'misc/get_reminders/' + <?php echo $lead->id; ?> + '/' + 'lead', [4], [4],undefined,[1,'ASC']);"
			...
			<li role="presentation"><a href="#lead_notes"
				aria-controls="lead_notes" role="tab" data-toggle="tab">
            <?php echo _l('lead_add_edit_notes'); ?>
            </a></li>
			<li role="presentation"><a href="#lead_activity"
				aria-controls="lead_activity" role="tab" data-toggle="tab">
      ...
      <div role="tabpanel" class="tab-pane" id="tab_email_activity">
         ...
         <div class="lead-email-activity">
				...
				<div class="media-body">
                  ...
                  <br /> <small class="text-muted display-block mtop5"><?php echo _dt($_mail_activity['dateadded']); ?></small>
					</h4>
      ...
      <div role="tabpanel" class="tab-pane" id="lead_activity">
			<div class="panel_s">
               ...
               <div class="feed-item">
                     ...
                     <a
								href="<?php echo admin_url('profile/'.$log["staffid"]); ?>">
                     <?php
                
echo staff_profile_image($log['staffid'], array(
		...
		<div role="tabpanel" class="tab-pane" id="tab_proposals_leads">
         ...
         <a
				href="<?php echo admin_url('proposals/proposal?rel_type=lead&rel_id='.$lead->id); ?>"
        ...
        $custom_fields = get_custom_fields('proposal', array(
            'show_on_table' => 1
        ));
		...
		<div role="tabpanel" class="tab-pane" id="lead_reminders">
			<a href="#" data-toggle="modal" class="btn btn-info btn-xs"
				...
				class="fa fa-bell-o"></i> <?php echo _l('lead_set_reminder_title'); ?></a>
			<hr />
		...
		<div role="tabpanel" class="tab-pane" id="lead_notes">
         ...
         <button type="submit" class="btn btn-info pull-right"><?php echo _l('lead_add_edit_add_note'); ?></button>
			...
			<div class="radio radio-primary">
				<input type="radio" name="contacted_indicator"
					id="contacted_indicator_yes" value="yes"> <label
					for="contacted_indicator_yes"><?php echo _l('lead_add_edit_contacted_this_lead'); ?></label>
			</div>
			<div class="radio radio-primary">
				<input type="radio" name="contacted_indicator"
					id="contacted_indicator_no" value="no" checked> <label
					for="contacted_indicator_no"><?php echo _l('lead_not_contacted'); ?></label>
			</div>
         <?php echo form_close(); ?>
         <hr />
            ...
            <div class="media lead-note">
               ...
               <?php echo staff_profile_image($note['addedfrom'],array('staff-profile-image-small','pull-left mright10')); ?>
                  ...
                  <a href="#" class="pull-right text-danger"
							...
							class="fa fa fa-times"></i></a> <a href="#"
                  ...
                  <span data-toggle="tooltip"
							data-title="<?php echo _dt($note['date_contacted']); ?>"> <i
							class="fa fa-phone-square text-success font-medium valign"
							aria-hidden="true"></i>
						</span>
                  <?php } ?>
