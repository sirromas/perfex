...
<a href="#" class="close_newsfeed" data-close="true"><i
	...
	<div class="col-md-6 col-md-offset-3">
        ...
        <a href="<?php echo admin_url('profile'); ?>">
          ...
          <?php echo $current_user->firstname . ' ' . $current_user->lastname ;?></a>
				...
				<a href="#" class="btn btn-default add-post-attachments"><i
					data-toggle="tooltip"
					title="<?php echo _l('newsfeed_upload_tooltip'); ?>"
					class="fa fa-files-o"></i></a> <select id="post-visibility"
					class="selectpicker" multiple name="visibility[]" data-width="60%"
