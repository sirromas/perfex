        ...
        <div class="mobile-menu">
            ...
            <ul class="mobile-icon-menu">
                ...
                <li class="header-timers">
                    <a href="#" class="dropdown-toggle top-timers<?php if(count($startedTimers) > 0){echo ' text-success';} ?>" data-toggle="dropdown"><i class="fa fa-clock-o"></i></a>
...
<li class="icon header-todo">
    <a href="<?php echo admin_url('todo'); ?>" data-toggle="tooltip" title="<?php echo _l('nav_todo_items'); ?>" data-placement="bottom"><i class="fa fa-bars"></i>
