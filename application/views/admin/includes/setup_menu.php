<div id="setup-menu-wrapper"
	class="animated <?php if($this->session->has_userdata('setup-menu-open') && $this->session->userdata('setup-menu-open') == true){echo 'display-block';} ?>">
	<ul class="nav metis-menu" id="setup-menu">
		<li><a class="close-customizer"><i class="fa fa-close"></i></a> <span
			class="text-left bold customizer-heading"><?php echo _l('setting_bar_heading'); ?></span>
		</li>
        <?php
        ...
        foreach ($menu_active->setup_menu_active as $item) {
            ...
            ?>
            <li><a href="<?php echo $url; ?>"><?php if(!empty($item->icon)){ ?><i
				class="<?php echo $item->icon; ?> menu-icon"></i><?php } ?><?php echo _l($item->name); ?>
                    <?php if($submenu == true){ ?>
...
foreach ($item->children as $submenu) {
                    ...
                    ?>
                       <li><a href="<?php echo $url; ?>">
                            ...
                            <i
						class="<?php echo $submenu->icon; ?> menu-icon"></i>
                            <?php } ?>
        ...
        <li><a
			href="<?php echo do_action('help_menu_item_link','https://help.perfexcrm.com'); ?>"
			target="_blank"><?php echo do_action('help_menu_item_text',_l('setup_help')); ?></a>
		</li>
        <?php } ?>
    </ul>
</div>
