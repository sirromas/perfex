...
if ($expense->recurring == 1) {
        ...
        ?>
         <ul class="nav nav-tabs" role="tablist">
				<li role="presentation" class="active"><a href="#tab_expense"
					aria-controls="tab_expense" role="tab" data-toggle="tab">
               <?php echo _l('expense'); ?>
               </a></li>
            <?php if($expense->recurring > 0) { ?>
            <li role="presentation"><a href="#tab_child_expenses"
					aria-controls="tab_child_expenses" role="tab" data-toggle="tab">
            ...
            <li role="presentation"><a href="#tab_tasks"
               ...
               <?php echo _l('tasks'); ?>
				...
				<li role="presentation"><a href="#tab_reminders"
					onclick="initDataTable('.table-reminders', admin_url + 'misc/get_reminders/' + <?php echo $expense->id ;?> + '/' + 'expense', [4], [4],undefined,[1,'ASC']); return false;"
			...
			<div class="row">
               ...
               <button type="button"
						class="btn btn-success pull-right mleft5 expense_convert_btn"
               ...
               <a
						href="<?php echo admin_url('invoices/list_invoices/'.$expense->invoiceid); ?>"
						class="btn mleft10 pull-right btn-info"><?php echo format_invoice_number($invoice->id); ?></a>
               <?php } ?>
               <div class="pull-right">
                  ...
                  <a class="btn btn-default btn-with-tooltip"
							...
							data-toggle="tooltip" data-placement="bottom"
							title="<?php echo _l('expense_copy'); ?>"><i class="fa fa-clone"></i></a>
                  <?php } ?>
                  ...
                  <a class="btn btn-danger btn-with-tooltip _delete"
							...
							data-toggle="tooltip" data-placement="bottom"
							title="<?php echo _l('expense_delete'); ?>"><i
			...
			<div class="tab-content">
				<div role="tabpanel" class="tab-pane ptop10 active" id="tab_expense">
                  ...
                  <p>
							...
							<span class="text-danger bold font-medium"><?php echo format_money($expense->amount,$expense->currency_data->symbol); ?></span>
                     <?php
...
if ($expense->billable == 1) {
                    ...
                    ?>
						...
						<p>
							<span class="bold"><?php echo _l('expense_date'); ?></span> <span
								class="text-muted"><?php echo _d($expense->date); ?></span>
						</p>
						<br /> <br />
                  <?php if(!empty($expense->reference_no)){ ?>
                  <p class="bold"><?php echo _l('expense_ref_noe'); ?> <span
								class="text-muted"><?php echo $expense->reference_no; ?></span>
						</p>
                  <?php } ?>
         ...
         <div role="tabpanel" class="tab-pane" id="tab_child_expenses">
            ...
            <p class="mtop30 bold"><?php echo _l('expenses_created_from_this_recurring_expense'); ?></p>
               ...
               <li class="list-group-item"><a
						href="<?php echo admin_url('expenses/list_expenses/'.$recurring->expenseid); ?>"
                     ...
                     <?php echo '<span class="bold">'._d($recurring->date).'</span>'; ?><br />
							<p>
								<span class="bold font-medium"><?php echo _l('expense_amount'); ?></span>
								<span class="text-danger bold font-medium"><?php echo format_money($recurring->amount,$recurring->currency_data->symbol); ?></span>
                        <?php
                    if ($recurring->tax != 0) {
         ...
         <div role="tabpanel" class="tab-pane" id="tab_tasks">
			...
			<div role="tabpanel" class="tab-pane" id="tab_reminders">
				<a href="#" data-toggle="modal" class="btn btn-info btn-xs"
					...
					class="fa fa-bell-o"></i> <?php echo _l('expense_set_reminder_title'); ?></a>
				<hr />
...
<script>
   ...
   if($('#dropzoneDragArea').length > 0){
     ...
     expensePreviewDropzone = new Dropzone("#expense-receipt-upload", {
