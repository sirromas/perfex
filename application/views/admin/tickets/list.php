...
<div id="wrapper">
	<div class="content">
		<div class="row">
			<div class="col-md-12">
              ...
              <?php echo _l('new_ticket'); ?>
            </a> <a href="#" class="btn btn-default btn-with-tooltip"
                    ...
                    <?php echo _l('task_list_all'); ?>
									...
									<li><a href="" data-cview="my_tickets"
										onclick="dt_custom_view('my_tickets','.tickets-table','my_tickets'); return false;"><?php echo _l('my_tickets_assigned'); ?></a>
									</li>
									<li class="divider"></li>
                <?php foreach($statuses as $status){ ?>
                <li
										class="<?php if($status['ticketstatusid'] == $chosen_ticket_status || $chosen_ticket_status == '' && in_array($status['ticketstatusid'], $default_tickets_list_statuses)){echo 'active';} ?>">
										<a href="#"
              ...
              <?php } ?>
						...
						<div class="panel_s animated weekly-ticket-opening"
							style="display: none;">
        ...
        <a href="#" data-toggle="modal"
							data-target="#tickets_bulk_actions" class="bulk-actions-btn hide"
...
<div class="modal fade bulk_actions" id="tickets_bulk_actions"
