			...
			<div class="col-md-12">
				<div class="panel_s">
					<div class="panel-body">
						<div class="_buttons">
							<a href="#" onclick="new_priority(); return false;"
								class="btn btn-info pull-left display-block"><?php echo _l('new_ticket_priority'); ?></a>
						</div>
							...
							<tbody>
								...
								<tr>
									...
									<td><a href="#"
										...
										data-name="<?php echo $priority['name']; ?>"><?php echo $priority['name']; ?></a></td>
									<td><a href="#"
										onclick="edit_priority(this,<?php echo $priority['priorityid']; ?>); return false"
										data-name="<?php echo $priority['name']; ?>"
										class="btn btn-default btn-icon"><i
											class="fa fa-pencil-square-o"></i></a> <a
										href="<?php echo admin_url('tickets/delete_priority/'.$priority['priorityid']); ?>"
