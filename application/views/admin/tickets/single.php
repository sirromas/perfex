			...
			<div class="col-md-12">
					...
					<div class="panel-body">
						...
						<ul class="nav nav-tabs no-margin" role="tablist">
							<li role="presentation"
								...
								<a href="#addreply" aria-controls="addreply" role="tab"
								data-toggle="tab">
							...
							<li role="presentation"><a href="#othertickets"
				...
				<div class="panel_s">
					<div class="panel-body">
						<div class="row">
							<div class="col-md-8">
								<h3 id="ticket_subject" class="mtop5 mbot10">
...
if ($ticket->project_id != 0) {
											...
											<div class="table-responsive">
												<table>
													<tbody>
														...
														<tr>
															<td><span class="bold">
																	<?php echo staff_profile_image($note['addedfrom'],array('staff-profile-xs-image')); ?> <a
                    ...
                    ?>
															<div class="pull-right">
																	<a href="#" class="btn btn-default btn-icon"
																		...
																		class="mright10 _delete btn btn-danger btn-icon"> <i
															...
															<hr />
																...
																<div
																	data-note-edit-textarea="<?php echo $note['id']; ?>"
							...
							<div>
								...
								<a
										href="<?php echo admin_url('tickets/delete/'.$ticket->ticketid); ?>"
										class="btn btn-danger _delete btn-ticket-label mright5"> <i
										class="fa fa-remove"></i>
									</a>
											...
											<div class="row">
												...
												<div class="checkbox checkbox-primary">
														<input type="checkbox" name="assign_to_current_user"
															id="assign_to_current_user"> <label
								...
								<div class="row">
									...
									<div class="form-group">
											<label for="contactid"><?php echo _l('contact'); ?></label> <select
												name="contactid" id="contactid" class="ajax-search"
        ...
        ?>
										...
										<div class="row">
											...
											<?php
        if ($ticket->userid != 0) {
            echo render_input('email', 'ticket_settings_email', $ticket->email, 'email', array(
                'disabled' => true
            ));
        } else {
            echo render_input('email', 'ticket_settings_email', $ticket->ticket_email, 'email', array(
                'disabled' => true
            ));
        }
        ?>
									...
									<div class="col-md-6">
										...
										<div class="form-group">
											...
											<option value="<?php echo $member['staffid']; ?>"
													<?php if($ticket->assigned == $member['staffid']){echo 'selected';} ?>>
        ...
        echo render_select('priority', $priorities, array(
            'priorityid',
            'name'
        ), 'ticket_settings_priority', $ticket->priority);
        ?>
										</div>
										...
										<div
											class="form-group projects-wrapper<?php if($ticket->userid == 0){echo ' hide';} ?>">
								...
								<div class="row">
									<div class="col-md-12 text-center">
										<hr />
										<a href="#"
											class="btn btn-info save_changes_settings_single_ticket">
										<?php echo _l('submit'); ?>
									</a>
									</div>
								</div>
				...
				<div class="panel_s mtop20">
					<div
						class="panel-body <?php if($ticket->admin == NULL){echo 'client-reply';} ?>">
						<div class="row">
                ...
                ?>
									<br /> <a href="mailto:<?php echo $ticket->ticket_email; ?>"><?php echo $ticket->ticket_email; ?></a>
								
								
								<hr />
									<?php
                if (total_rows('tblticketsspamcontrol', array(
                    'type' => 'sender',
                    'value' => $ticket->ticket_email
                )) == 0) {
                    ?>
									<button type="button"
									data-sender="<?php echo $ticket->ticket_email; ?>"
...
if (count($ticket->attachments) > 0) {
        ...
        foreach ($ticket->attachments as $attachment) {
            ...
            ?>
							<a
									href="<?php echo site_url('download/file/ticket/'. $attachment['id']); ?>"
									class="display-block mbot5"> <i
									class="<?php echo get_mime_class($attachment['filetype']); ?>"></i> <?php echo $attachment['file_name']; ?>
								<?php if($is_image){ ?>
								<img class="mtop5"
...
if ($is_image) {
    ...
    ?>
		...
		<div class="panel_s">
					<div
						class="panel-body <?php if($reply['admin'] == NULL){echo 'client-reply';} ?>">
						<div class="row">
							<div class="col-md-3 border-right">
								<p>
							...
							<br /> <a href="mailto:<?php echo $reply['reply_email']; ?>"><?php echo $reply['reply_email']; ?></a>
							<?php } ?>
							<?php }  else { ?>
...
if ($reply['admin'] !== NULL || $reply['admin'] != 0) {
    ...
    ?>
								...
								<hr />
								<a
									href="<?php echo admin_url('tickets/delete_ticket_reply/'.$ticket->ticketid .'/'.$reply['id']); ?>"
...
<a href="#top" id="toplink">↑</a> <a href="#bot" id="botlink">↓</a>
<?php } ?>
</div>
</div>
<!-- Modal -->
<div class="modal fade" id="ticket-message" tabindex="-1" role="dialog"
