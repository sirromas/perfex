<div class="modal fade" id="sales_item_modal" tabindex="-1"
				...
				<div class="row">
					<div class="col-md-12">
                        ...
                        foreach ($currencies as $currency) {
                            if ($currency['isdefault'] == 0 && total_rows('tblclients', array(
							...
							<input type="number"
								id="rate_currency_<?php echo $currency['id']; ?>"
                        ...
                        <div class="row">
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<select class="selectpicker display-block" disabled
										data-width="100%" name="tax2"
										data-none-selected-text="<?php echo _l('no_tax'); ?>">
										<option value=""></option>
                                <?php foreach($taxes as $tax){ ?>
                                <option
