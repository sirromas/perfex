      ...
      <div class="kan-ban-content">
        <ul class="sortable<?php if(has_permission('proposals','','edit')){echo ' status pipeline-status'; } ?>" data-status-id="<?php echo $status; ?>">
          ...
          <li class="text-center not-sortable kanban-load-more" data-load-status="<?php echo $status; ?>">
            <a href="#" class="btn btn-default btn-block<?php if($total_pages <= 1){echo ' disabled';} ?>" data-page="1" onclick="kanban_load_more(<?php echo $status; ?>,this,'proposals/pipeline_load_more',310,360); return false;";><?php echo _l('load_more'); ?></a>
          </li>
          <?php } ?>
