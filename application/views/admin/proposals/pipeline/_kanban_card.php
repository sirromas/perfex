...
<li data-proposal-id="<?php echo $proposal['id']; ?>"
	class="<?php if($proposal['invoice_id'] != NULL || $proposal['estimate_id'] != NULL){echo 'not-sortable';} ?>">
			...
			<div class="col-md-12">
				<h4 class="bold pipeline-heading">
					<a
						...
						onclick="proposal_pipeline_open(<?php echo $proposal['id']; ?>); return false;"><?php echo format_proposal_number($proposal['id']); ?></a>
				...
				<div class="row">
                  ...
                  <br />
					...
					<div class="col-md-4 text-right">
						<small><i class="fa fa-comments" aria-hidden="true"></i> <?php echo _l('proposal_comments'); ?>: <?php
    
echo total_rows('tblproposalcomments', array(
