			...
			<div class="col-md-12">
				<div class="panel_s">
                  ...
                  <a
							...
							class="btn btn-default mleft5 pull-left hidden-xs"><?php echo _l('switch_to_pipeline'); ?></a>
						<div class="display-block text-right">
                           ...
                           <div class="clearfix"></div>
									<li class="divider"></li>
									<li class="dropdown-submenu pull-left"><a href="#"
...
<script>
   ...
   $(function(){
     ...
     initDataTable('.table-proposals', window.location.href, ['undefined'], ['undefined'], Proposals_ServerParams, [7, 'DESC']);
     init_proposal();
   });
</script>
