<div class="modal fade" id="sync_data_proposal_data"
	data-rel-type="<?php echo $rel_type; ?>" tabindex="-1" role="dialog">
	<div class="modal-dialog" role="document">
        ...
        <?php echo render_input('address','proposal_address',$related->address); ?>
        <div class="row">
					<div class="col-md-6">
     ...
     <?php echo render_input('phone','proposal_phone',$related->phonenumber); ?>
			...
			<div class="modal-footer">
				...
				<button type="button" class="btn btn-info"
					onclick="sync_proposals_data(<?php echo $rel_id; ?>,'<?php echo $rel_type; ?>');"><?php echo _l('sync_now'); ?></button>
			</div>
		</div>
		<!-- /.modal-content -->
	</div>
