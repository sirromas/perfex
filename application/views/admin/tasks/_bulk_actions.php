...
<div class="modal fade bulk_actions" id="tasks_bulk_actions"
	tabindex="-1" role="dialog"
	data-table="<?php echo (isset($table) ? $table : '.table-tasks'); ?>">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
               ...
               <div id="bulk_change">
					<div class="form-group">
						...
						<select name="move_to_status_tasks_bulk_action"
							id="move_to_status_tasks_bulk_action" data-width="100%"
							class="selectpicker"
							data-none-selected-text="<?php echo _l('task_status'); ?>">
							<option value=""></option>
                  ...
                  <div class="form-group">
						...
						<select name="task_bulk_priority" class="selectpicker"
							id="task_bulk_priority" data-width="100%"
                  ...
                  <?php
                    ...
                    echo render_select('task_bulk_assignees', $staff_bulk_assigned, array(
                        'staffid',
                        array(
                            'firstname',
                            'lastname'
			...
			<div class="modal-footer">
				...
				<a href="#" class="btn btn-info"
					onclick="tasks_bulk_action(this); return false;"><?php echo _l('confirm'); ?></a>
			</div>
		</div>
		<!-- /.modal-content -->
	</div>
