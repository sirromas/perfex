...
<li data-task-id="<?php echo $task['id']; ?>">
	<div class="panel-body">
        ...
        ?>
          ...
          <span class="mright5 inline-block text-muted"
					data-toggle="tooltip"
					data-title="<?php echo _l('task_checklist_items'); ?>"> <i
					class="fa fa-check-square-o" aria-hidden="true"></i> <?php
            
echo total_rows('tbltaskchecklists', array(
                'taskid' => $task['id'],
                'finished' => 1
            ));
            ;
...
echo total_rows('tbltaskchecklists', array(
            ...
            ?>
              ...
              <span class="mright5 inline-block text-muted"
					data-toggle="tooltip"
					data-title="<?php echo _l('task_comments'); ?>"> <i
					class="fa fa-comments"></i> <?php
    
echo total_rows('tblstafftaskcomments', array(
        'taskid' => $task['id']
    ));
    ;
    ?>
...
$total_attachments = total_rows('tblfiles', array(
                ...
                ?>
                  <span class="inline-block text-muted"
					data-toggle="tooltip"
					data-title="<?php echo _l('task_view_attachments'); ?>"> <i
