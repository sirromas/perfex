        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="checkbox checkbox-primary checkbox-inline">
              <input type="checkbox" id="task_is_billable" name="billable" <?php if(isset($task)){if($task->billable == 1){echo 'checked';}} else {echo do_action('new_task_default_billable_checked','checked');}; ?>>
