<div class="modal-header task-single-header" data-task-single-id="<?php echo $task->id; ?>" data-status="<?php echo $task->status; ?>">
   ...
   <a href="#" onclick="init_lead(<?php echo $this->input->post('opened_from_lead_id'); ?>); return false;" class="text-success back-to-from-task" data-placement="left" data-toggle="tooltip" data-title="<?php echo _l('back_to_lead'); ?>">
...
<div class="modal-body">
   <div class="row">
      ...
      <?php if($task->billed == 0){
         ...
         <?php } ?>
         <div class="clearfix"></div>
         <?php if(total_rows('tbltaskstimers',array('end_time'=>NULL,'staff_id !='=>get_staff_user_id())) > 0){
         ...
         <div class="tasks-comments inline-block full-width" <?php if(count($task->comments) == 0){echo 'style="display:none"';} ?>>
            <textarea name="comment" placeholder="<?php echo _l('task_single_add_new_comment'); ?>" id="task_comment" rows="3" class="form-control"></textarea>
...
<div class="<?php if(date('Y-m-d') > $task->startdate && total_rows('tbltaskstimers',array('task_id'=>$task->id)) == 0 && $task->status != 5){echo 'text-danger';} ?> task-info">
...
<div class="task-info">
   <h5><i class="fa fa-rocket task-info-icon pull-left"></i>
...
<div class="task-info">
   <h5><i class="fa task-info-icon pull-left fa fa-credit-card"></i>
...
<div class="task-info text-success">
   <h5><i class="fa task-info-icon fa-clock-o"></i><?php echo _l('task_total_logged_time'); ?>
