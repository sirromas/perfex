					...
					<div class="panel-body">
						...
						<div class="_buttons">
							<a href="<?php echo admin_url('utilities/make_backup_db'); ?>"
								...
								data-target="#auto_backup_config"
...
foreach ($backups as $backup) {
            ...
            ?>
											<tr>
									<td><a
										href="<?php echo site_url('download/file/db_backup/' . $backup); ?>"><?php echo $backup; ?></a>
									</td>
									<td>
													<?php echo bytesToSize($_fullpath); ?>
												</td>
									<td
										data-order="<?php echo strftime('%Y-%m-%d %H:%M:%S', filectime($_fullpath)); ?>">
													<?php echo date('M dS, Y, g:i a',filectime($_fullpath)); ?>
												</td>
									<td><a
										href="<?php echo admin_url('utilities/delete_backup/'.$backup); ?>"
...
<div class="modal fade" id="auto_backup_config" tabindex="-1"
	role="dialog">
