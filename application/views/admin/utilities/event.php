...
<div class="modal fade _event" id="viewEvent">
	<div class="modal-dialog">
        ...
        <div class="modal-body">
								...
								<div class="col-md-6">
									<div class="input-group">
										<input type="number" class="form-control"
											...
											value="<?php echo $event->reminder_before; ?>"
											id="reminder_before"> <span class="input-group-addon"><i
								...
								<div class="col-md-6">
									<select name="reminder_before_type" id="reminder_before_type"
										...
										<option value="minutes"
											<?php if($event->reminder_before_type == 'minutes'){echo ' selected';} ?>><?php echo _l('minutes'); ?></option>
										<option value="hours"
											<?php if($event->reminder_before_type == 'hours'){echo ' selected';} ?>><?php echo _l('hours'); ?></option>
										<option value="days"
											<?php if($event->reminder_before_type == 'days'){echo ' selected';} ?>><?php echo _l('days'); ?></option>
										<option value="weeks"
											<?php if($event->reminder_before_type == 'weeks'){echo ' selected';} ?>><?php echo _l('weeks'); ?></option>
									</select>
								</div>
							</div>
						</div>
          ...
          <div class="clearfix"></div>
						...
						<div class="checkbox checkbox-primary">
							<input type="checkbox" name="public" id="event_public"
								<?php if($event->public == 1){echo 'checked';} ?>> <label
								for="event_public"><?php echo _l('utility_calendar_new_event_make_public'); ?></label>
						</div>
          <?php } else { ?>
      ...
      <button type="button" class="btn btn-danger"
					onclick="delete_event(<?php echo $event->eventid; ?>); return false"><?php echo _l('delete_event'); ?></button>
