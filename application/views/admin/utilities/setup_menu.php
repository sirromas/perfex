...
<div id="wrapper">
	<div class="content">
            ...
            <div class="clearfix"></div>
                ...
                foreach ($menu_active->setup_menu_active as $item) {
                    ...
                    <li class="dd-item dd3-item main"
                       ...
                       <?php } ?>
                       <a href="#"
												class="text-muted toggle-menu-options main-item-options pull-right"><i
												class="fa fa-cog"></i></a>
										</div>
										<div class="menu-options main-item-options"
											style="display: none;"
											data-menu-options="<?php echo $item->id; ?>">
											...
											<div class="input-group mbot15">
												...
												<input type="text" value="<?php echo $item->name; ?>"
													class="form-control main-item-name"
													name="name-menu-item-<?php echo $item->id; ?>"> <span
													class="input-group-addon"><i class="fa fa-question"
													data-toggle="tooltip" data-placement="left"
													data-title="<?php echo _l('utilities_menu_translate_name_help'); ?>"></i></span>
											</div>
                    ...
                    ?>
                        <input type="text" disabled
													value="<?php echo $url; ?>"
													class="form-control main-item-url"
													name="url-menu-item-<?php echo $item->id; ?>"> <span
													class="input-group-addon"><i class="fa fa-question"
													data-toggle="tooltip" data-placement="left"
													data-title="<?php echo _l('utilities_menu_url_help',admin_url()); ?>"></i></span>
											</div>
											<label class="control-label"><?php echo _l('utilities_menu_icon'); ?></label>
											<div class="input-group">
												<input type="text" value="<?php echo $item->icon; ?>"
													class="form-control main-item-icon icon-picker"> <span
													class="input-group-addon"> <i
													class="<?php echo $item->icon; ?>"></i>
												</span>
											</div>
										</div>
                  ...
                  <ol class="dd-list">
                    ...
                    <li class="dd-item dd3-item sub-items"
												...
												data-permission="<?php echo $submenu->permission; ?>">
												<div class="dd-handle dd3-handle"></div>
                       ...
                       <a href="#"
												...
												<div class="menu-options sub-item-options"
													style="display: none;"
													data-menu-options="<?php echo $submenu->id; ?>">
													<label class="control-label"><?php echo _l('utilities_menu_name'); ?></label>
													<div class="input-group">
														<input type="text" value="<?php echo $submenu->name; ?>"
															class="form-control sub-item-name"
															name="name-menu-item-<?php echo $submenu->id; ?>"> <span
															class="input-group-addon"><i class="fa fa-question"
															data-toggle="tooltip" data-placement="left"
															data-title="<?php echo _l('utilities_menu_translate_name_help'); ?>"></i></span>
													</div>
                        ...
                        <input type="text" disabled
															value="<?php echo $url; ?>"
															class="form-control sub-item-url"
															name="url-menu-item-<?php echo $submenu->id; ?>"> <span
															class="input-group-addon"><i class="fa fa-question"
															data-toggle="tooltip" data-placement="left"
															data-title="<?php echo _l('utilities_menu_url_help',admin_url()); ?>"></i></span>
													</div>
													<label class="control-label"><?php echo _l('utilities_menu_icon'); ?></label>
													<div class="input-group">
														<input type="text" value="<?php echo $submenu->icon; ?>"
															class="form-control main-item-icon icon-picker"> <span
															class="input-group-addon"> <i
															class="<?php echo $submenu->icon; ?>"></i>
														</span>
													</div>
												</div>
											</li>
        ...
        foreach ($menu_inactive->setup_menu_inactive as $item) {
            ...
            ?>
              <input type="text" disabled value="<?php echo $url; ?>"
													class="form-control main-item-url"
													name="url-menu-item-<?php echo $item->id; ?>"> <span
													class="input-group-addon"><i class="fa fa-question"
													data-toggle="tooltip" data-placement="left"
...
<link
	href="<?php echo base_url(); ?>assets/plugins/font-awesome-icon-picker/css/fontawesome-iconpicker.min.css"
	rel="stylesheet">
<script
	src="<?php echo base_url(); ?>assets/plugins/font-awesome-icon-picker/js/fontawesome-iconpicker.min.js"></script>
<script>
