				...
				<div class="panel_s">
					<div class="panel-body">
                        ...
                        <div class="form-group">
							...
							<select name="export_type" id="export_type" class="selectpicker"
								data-width="100%"
                        ...
                        <div class="form-group hide shifter"
							id="estimates_status">
							<label for="estimate_zip_status"><?php echo _l('bulk_export_status'); ?></label>
							<div class="radio radio-primary">
								<input type="radio" value="estimates_all" checked
									name="estimate_export_status"> <label for="estimates_all"><?php echo _l('bulk_export_status_all'); ?></label>
							</div>
                            <?php foreach($estimate_statuses as $status){ ?>
                            <div class="radio radio-primary">
								<input type="radio"
									id="<?php echo format_estimate_status($status,'',false); ?>"
									value="<?php echo $status; ?>" name="estimate_export_status"> <label
						...
						<div class="form-group hide shifter" id="invoices_status">
							...
							<div class="radio radio-primary">
								<input type="radio" id="all" value="all" checked
									name="invoice_export_status"> <label for="all"><?php echo _l('bulk_export_status_all'); ?></label>
							</div>
                            <?php foreach($invoice_statuses as $status){ ?>
                            <div class="radio radio-primary">
								<input type="radio"
									id="invoice_<?php echo format_invoice_status($status,'',false); ?>"
									value="<?php echo $status; ?>" name="invoice_export_status"> <label
						...
						<div class="form-group hide shifter" id="proposal_status">
							...
							<div class="radio radio-primary">
								<input type="radio" value="all" checked
									name="proposal_export_status"> <label for="all"><?php echo _l('bulk_export_status_all'); ?></label>
							</div>
                            <?php
...
foreach ($proposal_statuses as $status) {
						...
						<div class="form-group hide shifter" id="payment_modes">
                                <?php
                                array_unshift($payment_modes, array(
                                    'id' => '',
                                    'name' => _l('bulk_export_status_all')
                                ));
                                echo render_select('paymentmode', $payment_modes, array(
                                    'id',
                                    'name'
                                ), 'bulk_export_zip_payment_modes');
                                ?>
                            </div>
