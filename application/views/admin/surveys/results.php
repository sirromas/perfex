...
$x = 0;
								...
								<div class="col-md-12">
									<div class="row">
										...
										<div class="col-md-4 text-right">
                                            <?php
                                        $total_box_description_answers = total_rows('tblformresults', array(
                                            'rel_id' => $survey->surveyid,
                                            'boxdescriptionid' => $box_description['questionboxdescriptionid'],
                                            'rel_type' => 'survey'
                                        ));
                                        $total_box_answers = total_rows('tblformresults', array(
                                            'rel_id' => $survey->surveyid,
                                            'boxid' => $box_description['boxid'],
                                            'rel_type' => 'survey'
                                        ));
                                        ?>
                            ...
                            <?php
                                    ...
                                    if ($question['boxtype'] == 'input' || $question['boxtype'] == 'textarea') {
				...
				<div class="panel_s">
					...
					<div class="panel-body">
						...
						<a href="#questionid_<?php echo $question['questionid']; ?>"
							class="btn btn-info btn-xs" data-toggle="modal"><?php echo _l('survey_view_all_answers'); ?></a>
                        <?php
                        ...
                        <div class="modal fade"
                            ...
                            foreach ($answers as $answer) {
                                ?>
                                            <li
												class="text-success mbot10"><?php echo $i, ': ' .$answer['answer']; ?></li>
                                            <?php
                                $i ++;
                            }
                            ?>
