		...
		<div class="row">
                            ...
                            <?php echo $title; ?>
                                ...
                                foreach ($mail_lists as $list) {
                                  ...
                                  <div class="btn-group">
									...
									<ul class="dropdown-menu">
                                        ...
                                        <li><a href="#"
											class="add_email_list_custom_field_to_survey"
											data-toggle="tooltip"
											title="{<?php echo $custom_field['fieldslug']; ?>}"
											data-slug="{<?php echo $custom_field['fieldslug']; ?>}"><?php echo $custom_field['fieldname']; ?></a></li>
                                        <?php } ?>
                                    </ul>
								</div>
                                <?php } ?>
                                ...
                                <div class="checkbox checkbox-primary">
									<input type="checkbox" name="disabled" id="disabled"
										<?php if(isset($survey) && $survey->active == 0){echo 'checked';} ?>>
									<label for="disabled"><?php echo _l('survey_add_edit_disabled'); ?></label>
								</div>
								<div class="checkbox checkbox-primary">
									<input type="checkbox" name="onlyforloggedin"
										id="onlyforloggedin"
										<?php if(isset($survey) && $survey->onlyforloggedin == 1){echo 'checked';} ?>>
                             ...
                             <?php echo _l('send_survey_string'); ?>
                                ...
                                <div class="row">
									<div class="col-md-8">
										...
										<div class="form-group">
											<div class="checkbox checkbox-primary">
												<input type="checkbox" name="send_survey_to[clients]"
													id="ml_clients"> <label for="ml_clients"><?php echo _l('survey_send_mail_list_clients'); ?></label>
											</div>
											<div class="customer-groups" style="display: none;">
												...
												<div class="checkbox checkbox-primary mleft10">
													<input type="checkbox" checked name="ml_customers_all"
														id="ml_customers_all"> <label for="ml_customers_all"><?php echo _l('survey_customers_all'); ?></label>
												</div>
                                                <?php foreach($customers_groups as $group){ ?>
                                                <div
													class="checkbox checkbox-primary mleft10 survey-customer-groups">
													<input type="checkbox"
														name="customer_group[<?php echo $group['id']; ?>]"
														id="ml_customer_group_<?php echo $group['id']; ?>"> <label
											...
											<div class="checkbox checkbox-primary">
												<input type="checkbox" name="send_survey_to[leads]"
													id="ml_leads"> <label for="ml_leads"><?php echo _l('leads'); ?></label>
											</div>
											...
											<div class="leads-statuses" style="display: none;">
                                               ...
                                               <div
													class="checkbox checkbox-primary mleft10">
													<input type="checkbox" checked
														name="leads_status[<?php echo $status['id']; ?>]"
														id="ml_leads_status_<?php echo $status['id']; ?>"> <label
											...
											<div class="checkbox checkbox-primary">
												<input type="checkbox" name="send_survey_to[staff]"
													id="ml_staff"> <label for="ml_staff"><?php echo _l('survey_send_mail_list_staff'); ?></label>
											</div>
                                        ...
                                        <div
												...
												<input type="checkbox"
													...
													name="send_survey_to[<?php echo $list['listid']; ?>]"> <label
                                    ...
                                    <p class="text-success">
                                        ...
                                        <a
												href="<?php echo admin_url('surveys/remove_survey_send/'.$log['id']); ?>"
			...
			<div class="col-md-7" id="survey_questions_wrapper">
             ...
             <?php echo _l('survey_questions_string'); ?>
                ...
                <?php if(isset($survey)){ ?>
                <a href="#"
							onclick="survey_toggle_full_view(); return false;"
							data-toggle="tooltip"
							data-title="<?php echo _l('toggle_full_view'); ?>"
							class="toggle_view pull-left mtop10"> <i class="fa fa-expand"></i></a>
						<div class="_buttons">
                        <?php
                    if (total_rows('tblsurveyresultsets', 'surveyid=' . $survey->surveyid) > 0) {
                        ?>
                              <a
								href="<?php echo admin_url('surveys/results/' . $survey->surveyid); ?>"
								target="_blank"
								class="btn btn-success pull-right mleft10 btn-with-tooltip"
                        ...
                        <!-- Single button -->
							<a
								href="<?php echo site_url('survey/'.$survey->surveyid . '/' . $survey->hash); ?>"
								target="_blank"
								class="btn btn-success pull-right mleft10 btn-with-tooltip"
								data-toggle="tooltip" data-placement="bottom"
                    ...
                    if (count($survey->questions) > 0) {
                        foreach ($survey->questions as $question) {
                            ...
                            if ($question['boxtype'] == 'textarea') {
                                ...
                                if ($question['boxtype'] == 'checkbox' || $question['boxtype'] == 'radio') {
