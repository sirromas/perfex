         ...
         <div class="tab-content">
           <div role="tabpanel" class="tab-pane active kb-kan-ban kan-ban-tab" id="kan-ban">
             ...
             foreach($groups as $group){
               ...
               ?>
               <ul class="kan-ban-col<?php if(!$has_permission_edit){echo ' not-sortable'; } ?>" data-col-group-id="<?php echo $group['groupid']; ?>">
                 <li class="kan-ban-col-wrapper">
                  ...
                  <div class="kan-ban-content-wrapper">
                    <div class="kan-ban-content">
                     <ul class="sortable article-group groups<?php if(!$has_permission_edit){echo 'not-sortable'; } ?>" data-group-id="<?php echo $group['groupid']; ?>">
