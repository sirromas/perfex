		...
		<div class="row">
			<div class="col-md-12">
             ...
             <a
								...
								class="btn btn-info mright5"><?php echo _l('kb_article_new_article'); ?></a>
             <?php } ?>
             <a href="#"
								class="btn btn-default toggle-articles-list btn-with-tooltip"
								data-title="<?php echo _l('switch_to_list_view'); ?>"
								onclick="initKnowledgeBaseTableArticles(); return false;"><i
								class="fa fa-th-list"></i></a>
							<div
								class="btn-group pull-right mleft4 btn-with-tooltip-group _filter_data hide"
								data-toggle="tooltip"
              ...
              <li><a href="#"
										...
										onclick="dt_custom_view('kb_group_<?php echo $group['groupid']; ?>','.table-articles','kb_group_<?php echo $group['groupid']; ?>'); return false;"><?php echo $group['name']; ?></a></li>
              <?php } ?>
            </ul>
							</div>
...
foreach ($groups as $group) {
            ...
            ?>
						...
						<div class="row">
							<div class="tab-content">
								<div role="tabpanel"
									class="tab-pane active kb-kan-ban kan-ban-tab" id="kan-ban">
            ...
            foreach ($groups as $group) {
                ...
                ?>
               <ul
											class="kan-ban-col<?php if(!$has_permission_edit){echo ' not-sortable'; } ?>"
                ...
                ?>
                   <div class="panel-heading-bg primary-bg"
                    ...
                    <a href="#" onclick="return false;"
															...
															data-content="<div 
															class='kan-ban-settings cpicker-wrapper'><?php echo $kanban_colors; ?>
                ...
                ?>
                  <div class="kan-ban-content-wrapper">
													<div class="kan-ban-content">
														<ul
															class="sortable article-group groups<?php if(!$has_permission_edit){echo 'not-sortable'; } ?>"
															data-group-id="<?php echo $group['groupid']; ?>">
                      <?php foreach($articles as $article) { ?>
                      <li
																class="<?php if($article['active'] == 0){echo 'line-throught';} ?>"
                        ...
                        <a
                          ...
                          <?php } else { ?>
                          <a
																		href="<?php echo site_url('clients/knowledge_base/'.$article['slug']); ?>"
																		target="_blank">
                            <?php } ?><?php echo $article['subject']; ?></a>
                            <?php if($has_permission_edit){ ?>
                            <a
																		href="<?php echo admin_url('knowledge_base/article/'.$article['articleid']); ?>"
                            ...
                            <div class="clearfix"></div>
																		<hr />
																		<p class="pull-left">
																			<small><?php echo _l('article_total_views'); ?>: <?php echo total_rows('tblviewstracking',array('rel_type'=>'kb_article','rel_id'=>$article['articleid'])); ?></small>
																		</p>
                            <?php if($article['staff_article'] == 1){ ?>
