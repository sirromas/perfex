				...
				<div class="panel_s">
                    ...
                    <div class="_buttons">
							<a href="#" onclick="new_kb_group(); return false;"
								class="btn btn-info pull-left display-block"><?php echo _l('new_group'); ?></a>
						</div>
                    ...
                    <?php } ?>
                        <?php if(count($groups) > 0){ ?>
                                <table
							class="table dt-table scroll-responsive">
							<thead>
							...
							<tbody>
									...
									<td><?php echo $group['name']; ?> <span
										class="badge pull-right"><?php echo total_rows('tblknowledgebase','articlegroup='.$group['groupid']); ?></span></td>
									<td>
										<div class="onoffswitch">
											<input type="checkbox" id="<?php echo $group['groupid']; ?>"
												data-id="<?php echo $group['groupid']; ?>"
												class="onoffswitch-checkbox"
												<?php if(!has_permission('knowledge_base','','edit')){ echo 'disabled'; } ?>
												data-switch-url="<?php echo admin_url(); ?>knowledge_base/change_group_status"
												<?php if($group['active'] == 1){echo 'checked';} ?>> <label
									...
									<td>
                                        ...
                                        <?php if(has_permission('knowledge_base','','delete')){ ?>
                                            <a
										href="<?php echo admin_url('knowledge_base/delete_group/'.$group['groupid']); ?>"
