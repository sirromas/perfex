			...
			<div class="col-md-12">
				...
				<div class="panel_s">
					<div class="panel-body">
                        ...
                        <a
								href="<?php echo admin_url('clients/client'); ?>"
								class="btn btn-info mright5 test pull-left display-block">
                            <?php echo _l('new_client'); ?></a> <a
								href="<?php echo admin_url('clients/import'); ?>"
							...
							<div
								...
								<ul class="dropdown-menu dropdown-menu-left"
									...
									<li class="active"><a href="#" data-cview="all"
										onclick="dt_custom_view('','.table-clients',''); return false;"><?php echo _l('customers_sort_all'); ?></a></li>
									<li class="divider"></li>
										...
										<ul class="dropdown-menu dropdown-menu-left">
												...
												onclick="dt_custom_view('customer_group_<?php echo $group['id']; ?>','.table-clients','customer_group_<?php echo $group['id']; ?>'); return false;"><?php echo $group['name']; ?></a></li>
                                                    <?php } ?>
                                                </ul></li>
									<div class="clearfix"></div>
									<li class="divider"></li>
...
if (count($contacts_logged_in_today) > 0) {
						...
						<a href="#" data-toggle="modal"
							...
							class="bulk-actions-btn hide" data-table=".table-clients"><?php echo _l('bulk_actions'); ?></a>
