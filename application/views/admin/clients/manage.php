                    ...
                    <div class="panel-body">
                        <div class="_buttons">
                            <?php if (has_permission('customers', '', 'create')) { ?>
                                ...
                                ?>
                                <a href="#" id="my_clients" onclick="return false;"
                                   class="btn btn-info mright5 test pull-left display-block" style="display: block;">
                                    <?php echo _l('my_clients'); ?></a>

                                <a href="#" id="team_clients" onclick="return false;"
                                   class="btn btn-info mright5 test pull-left display-block" style="display: block;">
                                    <?php echo _l('team_clients'); ?></a>

                                <a href="#" id="all_clients" onclick="return false;"
                                   class="btn btn-info mright5 test pull-left display-block" style="display: block;">
                                    <?php echo _l('all_clients'); ?></a>
                            ...
                            <!--
                                <a
								href="<?php echo admin_url('clients/all_contacts'); ?>"
                            ...
                            <div
                                    class="btn-group pull-right btn-with-tooltip-group _filter_data"
                                    data-toggle="tooltip"
                                ...
                                <ul class="dropdown-menu dropdown-menu-left"
                                    ...
                                    <?php if (count($groups) > 0) { ?>
                                        <li
                                                class="dropdown-submenu pull-left groups"><a href="#"
                                    ...
                                    <?php } ?>
                                    <li
                                            class="dropdown-submenu pull-left invoice"><a href="#"
                                                                                          tabindex="-1"><?php echo _l('invoices'); ?></a>
                                        <ul class="dropdown-menu dropdown-menu-left">
                                            <?php foreach ($invoice_statuses as $status) { ?>
                                                <li><a href="#"
                                                       data-cview="invoices_<?php echo $status; ?>" data-cview="1"
                                    ...
                                    <div class="clearfix"></div>
                                    <li class="divider"></li>
                                    <li class="dropdown-submenu pull-left estimate"><a href="#"
                                                                                       tabindex="-1"><?php echo _l('estimates'); ?></a>
                                        <ul class="dropdown-menu dropdown-menu-left">
                                    ...
                                    <div class="clearfix"></div>
                                    <li class="divider"></li>
                                    <li class="dropdown-submenu pull-left project"><a href="#"
                                                                                      tabindex="-1"><?php echo _l('projects'); ?></a>
                                        <ul class="dropdown-menu dropdown-menu-left">
                                    ...
                                    <div class="clearfix"></div>
                                    <li class="divider"></li>
                                    <li class="dropdown-submenu pull-left proposal"><a href="#"
                                                                                       tabindex="-1"><?php echo _l('proposals'); ?></a>
                                        <ul class="dropdown-menu dropdown-menu-left">
                                    ...
                                    <?php if (count($contract_types) > 0) { ?>
                                        <li class="divider"></li>
                                        <li class="dropdown-submenu pull-left contract_types"><a
                                                    href="#" tabindex="-1"><?php echo _l('contract_types'); ?></a>
                                            <ul class="dropdown-menu dropdown-menu-left">
                                    ...
                                    <?php if (count($customer_admins) > 0 && (has_permission('customers', '', 'create') || has_permission('customers', '', 'edit'))) { ?>
                                        <li class="divider"></li>
                                        <li class="dropdown-submenu pull-left responsible_admin"><a
                                                    href="#" tabindex="-1"><?php echo _l('responsible_admin'); ?></a>
                                            <ul class="dropdown-menu dropdown-menu-left">
                                ...
                                <div class="col-md-2 col-xs-6">
                                    ...
                                    <span class="text-muted">
                                                ...
                                                if (count($contacts_logged_in_today) > 0) {
                                                    ...
                                                    ?>
                                                    <i
                                                            class="fa fa-user pointer" data-toggle="popover"
                                                            data-title="<?php echo _l('customers_summary_logged_in_today'); ?>"
                                                            data-html="true"
                                                            data-content="<?php echo $contactsTemplate; ?>"> </i>
                                                <?php } ?>
                        ...
                        <a href="#" data-toggle="modal"
                           data-target="#customers_bulk_action"
                           class="bulk-actions-btn hide"
                                    ...
                                    <div class="modal-body">
                                        <?php if (has_permission('customers', '', 'delete')) { ?>
                                            <div
                                                ...
                                                <input type="checkbox" name="mass_delete" id="mass_delete"> <label
...
<script>
    ...
    initDataTable('.table-clients', window.location.href, [not_sortable_clients, 0], [not_sortable_clients, 0], CustomersServerParams,<?php echo do_action('customers_table_default_order', json_encode(array(2, 'ASC'))); ?>);
    ...
    $("#my_clients").click(function () {
        console.log('My clients ...');
        var item = 'my_clients';
        var url = '/admin/clients/set_client_filter';
    ...
    $("#team_clients").click(function () {
        console.log('Team clients ...');
        var item = 'team_clients';
        var url = '/admin/clients/set_client_filter';
        $.post(url, {item: item}).done(function (data) {
            document.location.reload();
        });
