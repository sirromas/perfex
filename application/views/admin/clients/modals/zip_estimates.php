<!-- Zip Estimates -->
<div class="modal fade" id="client_zip_estimates" tabindex="-1"
						...
						<div class="form-group">
							...
							<div class="radio radio-primary">
								<input type="radio" value="all" id="all" checked
									name="estimate_zip_status"> <label for="all"><?php echo _l('client_zip_status_all'); ?></label>
							</div>
                            <?php foreach($estimate_statuses as $status){ ?>
                            <div class="radio radio-primary">
								<input type="radio" value="<?php echo $status; ?>"
									id="est_<?php echo $status; ?>" name="estimate_zip_status"> <label
									for="est_<?php echo $status; ?>"><?php echo format_estimate_status($status,'',false); ?></label>
							</div>
                            <?php } ?>
                        </div>
                        <?php
