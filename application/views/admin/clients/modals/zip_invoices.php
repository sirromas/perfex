<!-- Modal -->
<div class="modal fade" id="client_zip_invoices" tabindex="-1"
						...
						<div class="form-group">
							...
							<div class="radio radio-primary">
								<input type="radio" value="all" checked
									name="invoice_zip_status" id="all"> <label for="all"><?php echo _l('client_zip_status_all'); ?></label>
							</div>
                            <?php foreach($invoice_statuses as $status){ ?>
                                 <div class="radio radio-primary">
								<input type="radio" value="<?php echo $status; ?>"
									id="s_<?php echo $status; ?>" name="invoice_zip_status"> <label
									for="s_<?php echo $status; ?>"><?php echo format_invoice_status($status,'',false); ?></label>
							</div>
                            <?php } ?>
                        </div>
                        <?php
