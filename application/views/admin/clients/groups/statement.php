...
echo json_encode(array(
	...
	<div class="col-md-8 col-xs-12">
		<div class="text-right _buttons pull-right">
			...
			<a href="#" id="statement_print" target="_blank"
			...
			</a> <a href="" id="statement_pdf"
				class="btn btn-default btn-with-tooltip mright5"
				data-toggle="tooltip" title="<?php echo _l('view_pdf'); ?>"
				data-placement="bottom"> <i class="fa fa-file-pdf-o"></i>
			</a> <a href="#" class="btn-with-tooltip btn btn-default"
				data-toggle="modal" data-target="#statement_send_to_client"><span
				data-toggle="tooltip"
				data-title="<?php echo _l('send_to_email'); ?>"
...
<div class="modal fade email-template"
	data-editor-id=".<?php echo 'tinymce-'.$client->userid; ?>"
	id="statement_send_to_client" tabindex="-1" role="dialog"
				...
				<div class="row">
					<div class="col-md-12">
						<div class="form-group">
                            ...
                            echo render_select('send_to[]', $contacts, array(
                                'id',
                                'email',
                                'firstname,lastname'
                            ), 'invoice_estimate_sent_to_email', $selected, array(
                                'multiple' => true
                            ), array(), '', '', false);
                            ?>
                        </div>
...
add_action('after_js_scripts_render', 'parse_customer_statement_html');
