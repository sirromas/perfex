...
<button class="btn btn-info mbot25" data-toggle="modal"
	data-target="#entryModal">
	<i class="fa fa-lock" aria-hidden="true"></i> <?php echo _l('new_vault_entry'); ?></button>
...
<div class="panel panel-default panel-vault">
	<div class="panel-heading" role="tab"
      ...
      <a
			href="<?php echo admin_url('clients/vault_entry_delete/'.$entry['id']); ?>"
			class="pull-right text-danger _delete"><i class="fa fa-remove"></i></a>
		<a href="#"
			onclick="edit_vault_entry(<?php echo $entry['id']; ?>); return false;"
			class="pull-right text-muted"><i
			class="fa fa-pencil-square-o mright10"></i></a>
      <?php } ?>
...
<div class="modal fade" id="entryModal" tabindex="-1" role="dialog">
	<div class="modal-dialog" role="document">
      ...
      <div class="modal-content">
            ...
            <div id="vault_password_change_notice"
					class="help-block text-muted vault_password_change_notice hide">
					<small><?php echo _l('password_change_fill_notice'); ?></small>
				</div>
            <?php echo render_textarea('description','vault_description'); ?>
            <hr />
				<div class="radio radio-info">
					<input type="radio" name="visibility" value="1"
						id="only_creator_visible_all" checked> <label
						for="only_creator_visible_all"><?php echo _l('vault_entry_visible_to_all'); ?></label>
				</div>
				<div class="radio radio-info">
					<input type="radio" name="visibility" value="2"
						id="only_creator_visible_administrators"> <label
				...
				<div class="radio radio-info">
					<input type="radio" name="visibility" value="3"
						id="only_creator_visible_me"> <label for="only_creator_visible_me"><?php echo _l('vault_entry_visible_creator'); ?></label>
				</div>
				<hr />
				<div class="checkbox checkbox-info">
					<input type="checkbox" id="share_in_projects"
						name="share_in_projects"> <label for="share_in_projects"><?php echo _l('vault_entry_share_on_projects'); ?></label>
				</div>
			</div>
...
add_action('after_js_scripts_render', 'vault_form_validate');
