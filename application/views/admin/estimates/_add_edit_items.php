<div class="panel-body mtop10">
			...
			<div class="mtop10">
				...
				<div class="radio radio-primary radio-inline">
					<input type="radio" value="1" id="1" name="show_quantity_as"
						...
						<?php if(isset($estimate) && $estimate->show_quantity_as == 1){echo 'checked';}else{echo'checked';} ?>>
				...
				<div class="radio radio-primary radio-inline">
					<input type="radio" value="2" id="2" name="show_quantity_as"
						...
						<?php if(isset($estimate) && $estimate->show_quantity_as == 2){echo 'checked';} ?>>
				...
				<div class="radio radio-primary radio-inline">
					<input type="radio" id="3" value="3" name="show_quantity_as"
						...
						<?php if(isset($estimate) && $estimate->show_quantity_as == 3){echo 'checked';} ?>>
	...
	<div class="table-responsive s_table mtop10">
		<table
			class="table estimate-items-table items table-main-estimate-edit">
			<thead>
				<tr>
					<th></th>
					<th width="20%" class="text-left"><i
						...
						data-toggle="tooltip"
						data-title="<?php echo _l('item_description_new_lines_notice'); ?>"></i> <?php echo _l('estimate_table_item_heading'); ?></th>
    ...
    if (isset($estimate) && $estimate->show_quantity_as == 2) {
        ...
        if (isset($estimate) && $estimate->show_quantity_as == 3) {
    ...
    ?>
     <th width="10%" class="text-left qty"><?php echo $qty_heading; ?></th>
			...
			<tbody>
				<tr class="main">
					<td></td>
					<td><textarea name="description" rows="4" class="form-control"
							placeholder="<?php echo _l('item_description_placeholder'); ?>"></textarea>
					</td>
					<td><textarea name="long_description" rows="4" class="form-control"
...
?>
	...
	<div class="col-md-8 col-md-offset-4">
        ...
        ?>
        <input type="number" value="<?php echo $discount_percent; ?>"
						...
						<div class="row">
							...
							<div class="col-md-5">
								<input type="number" data-toggle="tooltip"
									...
									value="<?php if(isset($estimate)){echo $estimate->adjustment; } else { echo 0; } ?>"
