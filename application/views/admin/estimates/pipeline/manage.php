                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="kanban-leads-sort">
                                ...
                                <a href="#" onclick="estimates_pipeline_sort('datecreated'); return false"><?php echo _l('estimates_sort_datecreated'); ?></a>
                                |
                                <a href="#" onclick="estimates_pipeline_sort('date'); return false"><?php echo _l('estimates_sort_estimate_date'); ?></a>
                                |
                                <a href="#" onclick="estimates_pipeline_sort('pipeline_order');return false;"><?php echo _l('estimates_sort_pipeline'); ?></a>
                                |
                                <a href="#" onclick="estimates_pipeline_sort('expirydate');return false;"><?php echo _l('estimates_sort_expiry_date'); ?></a>
                            </div>
                        </div>
                    </div>
                    <div class="row">
