      ...
      <div class="col-md-12 mtop15">
         <div class="panel-body bottom-transaction">
            ...
            <div class="btn-bottom-toolbar text-right">
              <button type="button" class="btn-tr btn btn-info mleft10 estimate-form-submit save-and-send">
              <?php echo _l('save_and_send'); ?>
              </button>
              <button type="button" class="btn-tr btn btn-info mleft10 estimate-form-submit">
              <?php echo _l('submit'); ?>
              </button>
            </div>
         </div>
