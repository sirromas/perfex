	...
	<div class="panel_s">
		<div class="panel-body">
			<ul class="nav nav-tabs" role="tablist">
				<li role="presentation" class="active"><a href="#tab_estimate"
					aria-controls="tab_estimate" role="tab" data-toggle="tab">
               <?php echo _l('estimate'); ?>
               </a></li>
				<li role="presentation"><a href="#tab_tasks"
					onclick="init_rel_tasks_table(<?php echo $estimate->id; ?>,'estimate'); return false;"
					aria-controls="tab_tasks" role="tab" data-toggle="tab">
               <?php echo _l('tasks'); ?>
               </a></li>
				<li role="presentation"><a href="#tab_activity"
					aria-controls="tab_activity" role="tab" data-toggle="tab">
               <?php echo _l('estimate_view_activity_tooltip'); ?>
               </a></li>
				<li role="presentation"><a href="#tab_reminders"
					onclick="initDataTable('.table-reminders', admin_url + 'misc/get_reminders/' + <?php echo $estimate->id ;?> + '/' + 'estimate', [4], [4],undefined,[1,'ASC']); return false;"
            ...
            ?>
				...
				<li role="presentation"><a href="#tab_notes"
					onclick="get_estimate_notes(<?php echo $estimate->id; ?>); return false"
					aria-controls="tab_notes" role="tab" data-toggle="tab">
               <?php echo _l('estimate_notes'); ?>
               </a></li>
				<li role="presentation"><a href="#tab_views"
					aria-controls="tab_views" role="tab" data-toggle="tab">
               <?php echo _l('view_tracking'); ?>
				...
				<li role="presentation"><a href="#"
					...
					class="toggle_view"> <i class="fa fa-expand"></i></a></li>
			</ul>
			<div class="row">
				<div class="col-md-3">
               <?php echo format_estimate_status($estimate->status,'mtop5');  ?>
				...
				<div class="col-md-9">
                  ...
                  <a
							href="<?php echo admin_url('estimates/estimate/'.$estimate->id); ?>"
							class="btn btn-default btn-with-tooltip" data-toggle="tooltip"
							title="<?php echo _l('edit_estimate_tooltip'); ?>"
							data-placement="bottom"><i class="fa fa-pencil-square-o"></i></a>
                  <?php } ?>
                  <a
							href="<?php echo admin_url('estimates/pdf/'.$estimate->id.'?print=true'); ?>"
							target="_blank" class="btn btn-default btn-with-tooltip"
							data-toggle="tooltip" title="<?php echo _l('print'); ?>"
							data-placement="bottom"><i class="fa fa-print"></i></a> <a
							href="<?php echo admin_url('estimates/pdf/'.$estimate->id); ?>"
							class="btn btn-default btn-with-tooltip" data-toggle="tooltip"
							title="<?php echo _l('view_pdf'); ?>" data-placement="bottom"><i
                ...
                ?>
                  <a href="#"
							class="estimate-send-to-client btn btn-default btn-with-tooltip"
							data-toggle="tooltip" title="<?php echo $_tooltip; ?>"
                     ...
                     <?php echo _l('more'); ?> <span class="caret"></span>
							...
							<ul class="dropdown-menu dropdown-menu-right">
								<li><a
									href="<?php echo site_url('viewestimate/' . $estimate->id . '/' .  $estimate->hash) ?>"
									target="_blank">
...
if ($estimate->invoiceid == NULL) {
                        ...
                        <li><a
									href="<?php echo admin_url('estimates/copy/'.$estimate->id); ?>">
                        ...
                        <?php
                            if ((get_option('delete_only_on_last_estimate') == 1 && is_last_estimate($estimate->id)) || (get_option('delete_only_on_last_estimate') == 0)) {
                                ?>
                        <li><a
									href="<?php echo admin_url('estimates/delete/'.$estimate->id); ?>"
                  ...
                  <div class="btn-group pull-right mleft5">
							<button type="button" class="btn btn-success dropdown-toggle"
								data-toggle="dropdown" aria-haspopup="true"
								aria-expanded="false">
                     <?php echo _l('estimate_convert_to_invoice'); ?> <span
									class="caret"></span>
							</button>
							<ul class="dropdown-menu">
								<li><a
									href="<?php echo admin_url('estimates/convert_to_invoice/'.$estimate->id.'?save_as_draft=true'); ?>"><?php echo _l('convert_and_save_as_draft'); ?></a></li>
								<li class="divider">
								
								<li><a
									href="<?php echo admin_url('estimates/convert_to_invoice/'.$estimate->id); ?>"><?php echo _l('convert'); ?></a></li>
								</li>
							</ul>
						</div>
                  <?php } ?>
                  <?php } else { ?>
                  <a
							href="<?php echo admin_url('invoices/list_invoices/'.$estimate->invoice->id); ?>"
			...
			<div class="tab-content">
				<div role="tabpanel" class="tab-pane ptop10 active"
					id="tab_estimate">
					<div id="estimate-preview">
						<div class="row">
                     <?php if($estimate->project_id != 0){ ?>
                     <div class="col-md-12">
								<h4 class="font-medium bold"><?php
                        
echo _l('related_to_project', array(
...
$pdf_custom_fields = get_custom_fields('estimate', array(
						...
						<div class="row">
							...
							<div class="col-md-4 col-md-offset-8">
                              ...
                              <tr>
											<td><span class="bold"><?php echo _l('estimate_discount'); ?> (<?php echo _format_number($estimate->discount_percent,true); ?>%)</span>
											</td>
											<td class="discount">
                            ...
                            ?>
                              ...
                              <tr>
											<td><span class="bold"><?php echo _l('estimate_adjustment'); ?></span>
											</td>
											<td class="adjustment">
...
foreach ($estimate->attachments as $attachment) {
                     ...
                     <div class="mbot15 row col-md-12"
								...
								<div class="col-md-8">
									...
									<br /> <small class="text-muted"> <?php echo $attachment['filetype']; ?></small>
								</div>
...
if ($attachment['visible_to_customer'] == 0) {
                           ...
                           <a href="#" data-toggle="tooltip"
										...
										data-title="<?php echo $tooltip; ?>"><i
										class="<?php echo $icon; ?>" aria-hidden="true"></i></a>
               ...
               <?php init_relation_tasks_table(array('data-new-rel-id'=>$estimate->id,'data-new-rel-type'=>'estimate')); ?>
				...
				<div role="tabpanel" class="tab-pane" id="tab_reminders">
					<a href="#" data-toggle="modal" class="btn btn-info btn-xs"
               ...
               <?php echo form_close(); ?>
               <hr />
					<div class="panel_s mtop20" id="estimate_notes_area"></div>
				</div>
...
foreach ($activity as $activity) {
                            ...
                            ?>
                        <div class="feed-item"
									data-sale-activity-id="<?php echo $activity['id']; ?>">
									<div class="date"><?php echo time_ago($activity['date']); ?></div>
									<div class="text">
                              <?php if(is_numeric($activity['staffid']) && $activity['staffid'] != 0){ ?>
                              <a
											href="<?php echo admin_url('profile/'.$activity["staffid"]); ?>">
                              <?php
                                
echo staff_profile_image($activity['staffid'], array(
                                    'staff-profile-xs-image pull-left mright5'
                                ));
                                ?>
                              </a>
                              <?php } ?>
                            ...
                            if (! empty($activity['additional_data'])) {
                                ...
                                foreach ($additional_data as $data) {
                                    if (strpos($data, '<original_status>') !== false) {
                                        ...
                                        if (strpos($data, '<new_status>') !== false) {
                                            ...
                                            if (strpos($data, '<status>') !== false) {
                                                ...
                                                if (strpos($data, '<custom_data>') !== false) {
