					...
					<div class="col-md-12">
						...
						<div class="checkbox checkbox-primary checkbox-inline">
							<input type="checkbox" id="include_shipping"
								...
								<?php if(isset($estimate) && $estimate->include_shipping == 1){echo 'checked';} ?>>
							<label for="include_shipping"><?php echo _l('shipping_address'); ?></label>
						</div>
						<div id="shipping_details"
							class="<?php if((isset($estimate) && $estimate->include_shipping != 1) || !isset($estimate)){echo 'hide';} ?>">
							<div class="checkbox checkbox-primary checkbox-inline">
								<input type="checkbox" id="show_shipping_on_estimate"
									name="show_shipping_on_estimate"
									<?php if((isset($estimate) && $estimate->show_shipping_on_estimate == 1) || !isset($estimate)){echo 'checked';} ?>>
