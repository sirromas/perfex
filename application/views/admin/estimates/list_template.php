...
$this->load->view('admin/estimates/estimates_top_stats');
           ...
           <a href="<?php echo admin_url('estimates/estimate'); ?>"
				class="btn btn-info pull-left new new-estimate-btn"><?php echo _l('create_new_estimate'); ?></a>
           <?php } ?>
           <a
				href="<?php echo admin_url('estimates/pipeline/'.$switch_pipeline); ?>"
				class="btn btn-default mleft5 pull-left switch-pipeline hidden-xs"><?php echo _l('switch_to_pipeline'); ?></a>
			<div class="display-block text-right">
				<div
                  ...
                  <?php echo _l('estimates_list_all'); ?>
						...
						<li class="divider"></li>
						<li
							class="<?php if($this->input->get('filter') == 'not_sent'){echo 'active'; } ?>">
                  ...
                  <?php echo _l('estimate_invoiced'); ?>
						...
						<li><a href="#" data-cview="not_invoiced"
              ...
              <li
							class="<?php if($this->input->get('status') == $status){echo 'active';} ?>">
              ...
              <div class="clearfix"></div>
						<li class="divider"></li>
						<li class="dropdown-submenu pull-left"><a href="#" tabindex="-1"><?php echo _l('sale_agent_string'); ?></a>
							<ul class="dropdown-menu dropdown-menu-left">
                 <?php foreach($estimates_sale_agents as $agent){ ?>
                 <li><a href="#"
									data-cview="sale_agent_<?php echo $agent['sale_agent']; ?>"
									onclick="dt_custom_view(<?php echo $agent['sale_agent']; ?>,'.table-estimates','sale_agent_<?php echo $agent['sale_agent']; ?>'); return false;"><?php echo get_staff_full_name($agent['sale_agent']); ?>
                  </a></li>
                <?php } ?>
              </ul></li>
            <?php } ?>
            ...
            <?php } ?>
				...
				<a href="#"
					...
					data-toggle="tooltip"
					title="<?php echo _l('estimates_toggle_table_tooltip'); ?>"><i
					class="fa fa-angle-double-left"></i></a> <a href="#"
					class="btn btn-default btn-with-tooltip estimates-total"
    ...
    $custom_fields = get_custom_fields('estimate', array(
        'show_on_table' => 1
    ));
    ...
    ?>
		...
		<div class="col-md-7 small-table-right-col">
			<div id="estimate" class="hide"></div>
		</div>
	</div>
</div>
