...
<div class="panel_s no-padding">
	<div class="panel-body">
      ...
      <p>
			<a
				href="<?php echo admin_url('invoices/list_invoices/'.$_inv->id); ?>"
				target="_blank"><?php echo format_invoice_number($_inv->id); ?></a> - <?php echo format_money($_inv->total,$_inv->symbol); ?>
...
if ($invoice->recurring > 0) {
        ...
        ?>
         <ul class="nav nav-tabs" role="tablist">
				<li role="presentation" class="active"><a href="#tab_invoice"
					aria-controls="tab_invoice" role="tab" data-toggle="tab">
               <?php echo _l('invoice'); ?>
               </a></li>
            <?php if($invoice->recurring > 0) { ?>
            <li role="presentation"><a href="#tab_child_invoices"
					aria-controls="tab_child_invoices" role="tab" data-toggle="tab">
			...
			<div class="row">
               ...
               <?php echo format_invoice_status($invoice->status,'mtop5'); ?>
                ...
                ?>
                  ...
                  <a
							href="<?php echo admin_url('invoices/invoice/'.$invoice->id); ?>"
							data-toggle="tooltip"
                  ...
                  <?php } ?>
                  <a
							href="<?php echo admin_url('invoices/pdf/'.$invoice->id.'?print=true'); ?>"
							...
							href="<?php echo admin_url('invoices/pdf/'.$invoice->id); ?>"
							...
							class="invoice-send-to-client btn-with-tooltip btn btn-default"
                     ...
                     <?php echo _l('more'); ?> <span class="caret"></span>
                        ...
                        <li data-toggle="tooltip"
									data-title="<?php echo _l('delete_invoice_tooltip'); ?>"><a
									href="<?php echo admin_url('invoices/delete/'.$invoice->id); ?>"
                  ...
                  <a href="#"
							onclick="record_payment(<?php echo $invoice->id; ?>); return false;"
							class="mleft10 pull-right btn btn-success<?php if($invoice->status == 2 || $invoice->status == 5){echo ' disabled';} ?>"><?php echo _l('invoice_record_payment'); ?></a>
                  <?php } ?>
               </div>
				</div>
			</div>
...
if ($invoice->status == 6) {
                     ...
                     <div class="col-md-12">
								<h4 class="font-medium no-mtop"><?php
...
$pdf_custom_fields = get_custom_fields('invoice', array(
						...
						<div class="row">
							...
							<div class="col-md-4 col-md-offset-8">
                              ...
                              <tr>
											<td><span class="bold"><?php echo _l('invoice_discount'); ?> (<?php echo _format_number($invoice->discount_percent,true); ?>%)</span>
											</td>
											<td class="discount">
...
foreach ($taxes as $tax) {
                            ...
                            ?>
                              ...
                              <tr>
											<td><span class="bold"><?php echo _l('invoice_adjustment'); ?></span>
											</td>
											<td class="adjustment">
...
if ($attachment['visible_to_customer'] == 0) {
            ...
            <div role="tabpanel" class="tab-pane"
               ...
               <p class="mtop30 bold"><?php echo _l('invoice_add_edit_recurring_invoices_from_invoice'); ?></p>
                  ...
                  <li class="list-group-item"><a
							href="<?php echo admin_url('invoices/list_invoices/'.$recurring->id); ?>"
                     ...
                     <span class="pull-right bold"><?php echo format_money($recurring->total,$recurring->symbol); ?></span>
						</a> <br /> <span class="inline-block mtop10">
            ...
            <?php } ?>
            <div role="tabpanel" class="tab-pane ptop10"
					id="tab_activity">
					<div class="row">
						<div class="col-md-12">
