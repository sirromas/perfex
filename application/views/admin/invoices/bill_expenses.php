...
<div
	class="checkbox checkbox-primary invoice_inc_expense_additional_info">
	<input type="checkbox" id="inc_note"
		data-id="<?php echo $expense['id']; ?>"
		data-content="<?php echo $expense['note']; ?>"> <label for="inc_note"
		data-toggle="tooltip" data-title="<?php echo $expense['note']; ?>"><?php echo _l('expense'); ?> <?php echo _l('expense_add_edit_note'); ?></label>
</div>
<div
	class="checkbox checkbox-primary invoice_inc_expense_additional_info">
	<input type="checkbox" id="inc_name"
		data-id="<?php echo $expense['id']; ?>"
		data-content="<?php echo $expense['expense_name']; ?>"> <label
		for="inc_name" data-toggle="tooltip"
		data-title="<?php echo $expense['expense_name']; ?>"><?php echo _l('expense'); ?> <?php echo _l('expense_name'); ?></label>
</div>
<?php
        $additinal_action = ob_get_contents();
        $additinal_action = htmlspecialchars($additinal_action);
        ob_end_clean();
        $expense['currency_data'] = $this->currencies_model->get($expense['currency']);
        ?>
<div class="checkbox">
	<input type="checkbox" name="bill_expenses[]"
		value="<?php echo $expense['id']; ?>" data-toggle="popover"
		data-html="true" data-content="<?php echo $additinal_action; ?>"
		data-placement="bottom"> <label for=""><a
		href="<?php echo admin_url('expenses/list_expenses/'.$expense['id']); ?>"
