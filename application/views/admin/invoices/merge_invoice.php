...
<div class="checkbox">
	<input type="checkbox" name="invoices_to_merge[]"
		value="<?php echo $_inv->id; ?>"> <label for=""><a
		href="<?php echo admin_url('invoices/list_invoices/'.$_inv->id); ?>"
		data-toggle="tooltip"
		data-title="<?php echo format_invoice_status($_inv->status,'',false); ?>"
		target="_blank"><?php echo format_invoice_number($_inv->id); ?></a> - <?php echo format_money($_inv->total,$_inv->symbol); ?></label>
</div>
<?php
...
<div class="checkbox checkbox-info">
	<input type="checkbox" checked name="cancel_merged_invoices"
		id="cancel_merged_invoices"> <label for="cancel_merged_invoices"><i
		class="fa fa-question-circle" data-toggle="tooltip"
		data-title="<?php echo _l('invoice_merge_number_warning'); ?>"
		data-placement="bottom"></i> <?php echo _l('invoices_merge_cancel_merged_invoices'); ?></label>
</div>
</p>
<?php } ?>
