<div class="col-md-12">
   ...
   <div class="display-block text-right">
				<div
					class="btn-group pull-right mleft4 invoice-view-buttons btn-with-tooltip-group _filter_data"
         ...
         <?php echo _l('not_sent_indicator'); ?>
						...
						<li><a href="#" data-cview="not_have_payment"
     ...
     <li
							class="<?php if($status == $this->input->get('status')){echo 'active';} ?>">
     ...
     <div class="clearfix"></div>
        ...
        <li><a href="#"
									...
									onclick="dt_custom_view(<?php echo $agent['sale_agent']; ?>,'.table-invoices','sale_agent_<?php echo $agent['sale_agent']; ?>'); return false;"><?php echo get_staff_full_name($agent['sale_agent']); ?>
         </a></li>
       <?php } ?>
     </ul></li>
   <?php } ?>
...
foreach ($payment_modes as $mode) {
    ...
    ?>
     <li><a href="#"
							data-cview="invoice_payments_by_<?php echo $mode['id']; ?>"
     ...
     <?php } ?>
				...
				<a href="#"
					...
					class="btn btn-default btn-with-tooltip invoices-total"
    ...
    $custom_fields = get_custom_fields('invoice', array(
        'show_on_table' => 1
    ));
