...
$sTable = 'tblreminders';
$where = array(
    'AND staff = ' . get_staff_user_id() . ' AND isnotified = 0'
);
...
$join = array(
    ...
    'LEFT JOIN tblproposals ON tblproposals.id = tblreminders.rel_id AND tblreminders.rel_type="tblproposals"',
    'LEFT JOIN tblexpenses ON tblexpenses.id = tblreminders.rel_id AND tblreminders.rel_type="tblexpenses"'
);
