...
<div class="col-md-12">
	<div class="alert alert-warning font-medium">
		...
		<ul>
			...
			<strong><small>NOTE: The script can't check if Rocket Loader is
						enabled/disabled in your Cloudflare account. If Rocket Loader is
						already disabled you can ignore this warning.</small></strong></li>
			<li><br />
				<ul>
					...
					<br />
						...
						<p class="no-margin">
							&nbsp;&nbsp;- In the url field add the following url: <strong><?php echo rtrim(site_url(), '/').'/'; ?>*</strong>
						</p>
						<p class="no-margin">
...
<div style="font-size: 17px;">
	...
	<ul>
		...
		<li><a href="<?php echo admin_url('settings?group=pdf'); ?>"
			...
			now Custom PDF Company Logo URL should be only filename not full URL.</li>
