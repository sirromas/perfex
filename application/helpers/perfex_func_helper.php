...
function sec2qty($sec)
{
    ...
    $hookData = do_action('sec2qty_formatted', array(
        'seconds' => $sec,
        'qty' => $qty
    ));
...
/**
 *
 * @deprecated Format seconds to hours/minutes or seconds
 * @param mixed $seconds            
 * @return mixed
 */
 ...
 * 
 * @param mixed $hours
 *            total hours in format HH:MM or HH.MMM
 * @return int
 */
 ...
 *            data
 * @param $key -
 *            value you want to pluck from array
 *            
