 ...
 *            option to pass additional data for the templates eq is staff template or customer template
 ...
 *            password is used when sending welcome email, only 1 time
 * @return array
 */
 ...
 * @param mixed $task_id
 *            task id
 * @param boolean $client_template
 *            is client template or staff template
 * @return array
 */
 ...
 *            staff id
 * @param string $password
 *            password is used only when sending welcome email, 1 time
 * @return array
 */
 ...
 *            template name, used to identify url
...
/**
 *
 * @return array All available merge fields for templates are defined here
 */
