        ...
        if ($this->input->post()) {
            ...
            if ($oResponse->isSuccessful()) {
                if ($oResponseData->transactionResponse->responseCode == '1') {
                    $success = $this->authorize_aim_gateway->addPayment(array(
                        'amount' => $data['amount'],
							...
							<div class="form-group mtop15">
								<label class="control-label">
                                   <?php echo _l('payment_credit_card_number'); ?>
									...
									name="ccNo" id="ccNo" type="text" autocomplete="off" required />
							</div>
						</div>
						<div>
							<div class="form-group">
								<label class="control-label" for="expMonth">
                                 <?php echo _l('card_expiration_month'); ?> (MM)
									...
									name="expMonth" id="expMonth" type="number" maxlength="2"
									required />
							</div>
							<div class="form-group">
                               ...
                               <?php echo _l('card_expiration_year'); ?> (YYYY)
									...
									name="expYear" id="expYear" type="number" maxlength="4"
									required />
							</div>
						</div>
						<div>
							...
							<div class="form-group mtop15">
								<label class="control-label">
                                   <?php echo _l('payment_cardholder_name'); ?>
									...
									name="billingName" class="form-control"
									value="<?php echo $data['billing_name']; ?>" required>
							</div>
							<div class="row">
								<div class="col-md-12">
									<div class="form-group">
