        ...
        if ($this->input->post()) {
            ...
            if ($oResponse->isSuccessful()) {
                ...
                if ($oResponse['response']['responseCode'] == 'APPROVED') {
                    ...
                    $success = $this->two_checkout_gateway->addPayment(array(
			...
			<div class="row">
				<div class="panel_s">
					<div class="panel-body">
						<h4 class="no-margin">
                            <?php echo _l('payment_for_invoice'); ?> <a
								href="<?php echo site_url('viewinvoice/'. $data['invoice']->id . '/' . $data['invoice']->hash); ?>"><?php echo format_invoice_number($data['invoice']->id); ?></a>
						</h4>
						<hr />
						<p class="text-info"><?php echo _l('2checkout_notice_payment'); ?></p>
						<p>
							<span class="bold"><?php echo _l('payment_total',format_money($data['total'],$data['invoice']->symbol)); ?></span>
						</p>
						...
						<div>
							<div class="form-group">
                               ...
                               <?php echo _l('payment_credit_card_number'); ?>
									...
									id="ccNo" type="text" autocomplete="off" required />
							</div>
						</div>
						<div>
							<div class="row">
								<div class="form-group">
									...
									<div class="col-md-6">
										<input class="form-control" id="expMonth" type="number"
											maxlength="2" required />
									</div>
									<div class="col-md-6">
										<input class="form-control" id="expYear" type="number"
						...
						<div>
							<div class="form-group mtop15">
								<label class="control-label"> CVC </label> <input
									class="form-control" id="cvv" type="text" autocomplete="off"
									required />
							</div>
							...
							<div class="form-group">
                               ...
                               <?php echo _l('payment_cardholder_name'); ?>
									...
									name="billingName" class="form-control" required>
							</div>
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
                                     ...
                                     <?php echo _l('billing_address'); ?>
											...
											name="billingAddress1" class="form-control" required
								...
								<div class="col-md-6">
									<div class="form-group">
                                     ...
                                     <?php echo _l('billing_address'); ?> 2
											...
											name="billingAddress2" class="form-control"
											<?php if($data['address_2_required'] == true){echo 'required';} ?>>
									</div>
								</div>
								...
								<div class="col-md-6">
									<div class="form-group">
                                     ...
                                     <?php echo _l('billing_city'); ?>
											...
											name="billingCity" class="form-control" required
								...
								<div class="col-md-6">
									<div class="form-group">
                                     ...
                                     <?php echo _l('billing_state'); ?>
											...
											name="billingState" class="form-control"
											<?php if($data['state_required'] == true){echo 'required';} ?>
								...
								<div class="col-md-6">
									<div class="form-group">
                                     ...
                                     <?php echo _l('billing_country'); ?>
											...
											name="billingCountry" class="form-control" required>
											<option value=""></option>
                                        <?php
...
foreach (get_all_countries() as $country) {
        ...
        ?>
								...
								<div class="col-md-6">
									<div class="form-group">
                                     ...
                                     <?php echo _l('billing_zip'); ?>
											...
											name="billingPostcode" class="form-control"
											<?php if($data['zip_code_required'] == true){echo 'required';} ?>
						...
						<input type="submit" class="btn btn-info"
							value="<?php echo _l('submit_payment'); ?>" />
						</form>
					</div>
				</div>
			</div>
