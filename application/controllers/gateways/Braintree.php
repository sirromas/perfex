    ...
    public function complete_purchase()
    {
        if ($this->input->post()) {
            ...
            if ($oResponse->isSuccessful()) {
                ...
                $success = $this->paypal_braintree_gateway->addPayment(array(
                    'amount' => $data['amount'],
...
<body class="gateway-braintree">
	<div class="container">
              ...
              <?php echo format_invoice_number($data['invoice']->id); ?>
                ...
                <?php echo _l('payment_total',format_money($data['total'],$data['invoice']->symbol)); ?>
						...
						<form method="post" id="payment-form"
							action="<?php echo site_url('gateways/braintree/complete_purchase'); ?>">
							<section>
								<div class="bt-drop-in-wrapper">
									<div id="bt-dropin"></div>
								</div>
								<input id="amount" name="amount" type="hidden"
									value="<?php echo number_format($data['total'], 2, '.', ''); ?>">
		...
		<script
			src="https://js.braintreegateway.com/js/braintree-2.30.0.min.js"></script>
		<script>
