...
class Staff extends Admin_controller
{
    ...
    {
        $dialog = $this->roles_model->get_add_team_modal_dialog();
        echo $dialog;
    }
    ...
    public function add_new_team()
    {
        ...
        $this->roles_model->add_new_team($name);
    }

    /**
     *
     */
    public function update_teams_data()
    {
        $items = $this->input->post('items');
        $this->roles_model->update_teams_data($items);
    }
    ...
    {
        $items = $this->input->post('items');
        $status = $this->roles_model->delete_teams($items);
        echo $status;
    }
}
